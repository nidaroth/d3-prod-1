...
if($flag == 1){
	...
	$i = 0;
	while (!$res->EOF) { 
		$data['NOTE_TYPES'][$i]['ID'] 			 = $res->fields['PK_NOTE_TYPE'];
		$data['NOTE_TYPES'][$i]['TEXT'] 	 	 = $res->fields['NOTE_TYPE'];
		$data['NOTE_TYPES'][$i]['DEPARTMENT'] 	 = $res->fields['DEPARTMENT'];
		$data['NOTE_TYPES'][$i]['DEPARTMENT_ID'] = $res->fields['PK_DEPARTMENT'];
		$data['NOTE_TYPES'][$i]['DESCRIPTION'] 	 = $res->fields['DESCRIPTION'];
