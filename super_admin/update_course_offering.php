...
<head>
	...
	<title>Update Course Offering | <?=$title?></title>
</head>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Update Course Offering</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
							...
							<form class="floating-labels m-t-40" method="post" name="form1" id="form1" enctype="multipart/form-data" >
								<div class="p-20">
									...
									<div class="d-flex">
										...
										<div class="col-6 col-sm-6" >
											<b>Description:</b> For data conversion purposes only. Updates grades for specific Course Offerings for an account using data from the Course Offering Grade Book. If Course Offering Grade Book is blank, the grade will be calculated as zero.
											<br /><br />
