...
if(!empty($_POST)){
	...
	if($_GET['id'] == ''){
		...
		db_perform('Z_ANNOUNCEMENT', $ANNOUNCEMENT, 'update'," PK_ANNOUNCEMENT = '$_GET[id]' AND ANNOUNCEMENT_FROM = 1 ");
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor"><? if($_GET['id'] == '') echo "Add"; else echo "Edit"; ?> Announcement </h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
									...
									<div class="row">
                                        <div class="col-md-6">
											<div class="form-group m-b-5"  style="text-align:right" >
												...
												<button type="button" class="btn waves-effect waves-light btn-dark" onclick="window.location.href='manage_announcement'" >Cancel</button>
