...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_HELP_SUB_CATEGORY WHERE PK_HELP_SUB_CATEGORY = '$_GET[id]' ");;
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor">Help Subcategory </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="help_sub_category" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_help_sub_category"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_HELP_SUB_CATEGORY" width="150px" hidden="true" sortable="true" ></th>
													<th field="HELP_CATEGORY" width="400px" align="left" sortable="true" >Category</th>
													<th field="HELP_SUB_CATEGORY" width="400px" align="left" sortable="true" >Subcategory</th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='help_sub_category?id='+selected_row.PK_HELP_SUB_CATEGORY;
					}
				}
			});
