...
if(!empty($_POST)){
	...
	if($_GET['id'] == ''){
		$ATTENDANCE_CODE['CREATED_BY']  = $_SESSION['ADMIN_PK_USER'];
		$ATTENDANCE_CODE['CREATED_ON']  = date("Y-m-d H:i");
		db_perform('M_ATTENDANCE_CODE', $ATTENDANCE_CODE, 'insert');
	} else {
		$ATTENDANCE_CODE['EDITED_BY'] = $_SESSION['ADMIN_PK_USER'];
		$ATTENDANCE_CODE['EDITED_ON'] = date("Y-m-d H:i");
		db_perform('M_ATTENDANCE_CODE', $ATTENDANCE_CODE, 'update'," PK_ATTENDANCE_CODE = '$_GET[id]'");
	}
...
if($_GET['id'] == ''){
	...
	$res = $db->Execute("SELECT * FROM M_ATTENDANCE_CODE WHERE PK_ATTENDANCE_CODE = '$_GET[id]' "); 
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><? if($_GET['id'] == '') echo "Add"; else echo "Edit"; ?> Attendance Code </h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
