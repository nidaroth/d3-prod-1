...
if(!empty($_POST)){
	...
	if($_GET['id'] == ''){
		...
		db_perform('Z_EMAIL_TEMPLATE', $EMAIL_TEMPLATE, 'insert');
	} else {
		$EMAIL_TEMPLATE['EDITED_BY'] = $_SESSION['PK_USER'];
		$EMAIL_TEMPLATE['EDITED_ON'] = date("Y-m-d H:i");
		db_perform('Z_EMAIL_TEMPLATE', $EMAIL_TEMPLATE, 'update'," PK_EMAIL_TEMPLATE = '$_GET[id]' ");
	}
...
if($_GET['id'] == ''){
	...
	$res = $db->Execute("SELECT * FROM Z_EMAIL_TEMPLATE WHERE PK_EMAIL_TEMPLATE = '$_GET[id]' "); 
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><? if($_GET['id'] == '') echo ADD; else echo EDIT; ?> Mail Template </h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
