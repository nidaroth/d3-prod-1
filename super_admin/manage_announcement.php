...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM Z_ANNOUNCEMENT WHERE PK_ANNOUNCEMENT = '$_GET[id]' AND ANNOUNCEMENT_FROM = 1 ");
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="announcement" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
