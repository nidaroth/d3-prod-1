...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_FEE_TYPE WHERE PK_FEE_TYPE = '$_GET[id]' ");;
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="fee_type" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										...
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_FEE_TYPE" width="150px" hidden="true" sortable="true" ></th>
													<th field="FEE_TYPE" width="780px" align="left" sortable="true" >Fee Type</th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='fee_type?id='+selected_row.PK_FEE_TYPE;
					}
				}
			});
