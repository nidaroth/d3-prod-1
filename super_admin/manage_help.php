...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM Z_HELP WHERE PK_HELP = '$_GET[id]' ");
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="help" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_help"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_HELP" width="80px" sortable="true" >ID</th>
													<th field="HELP_CATEGORY" width="200px" align="left" sortable="true" >Category</th>
													<th field="HELP_SUB_CATEGORY" width="200px" align="left" sortable="true" >Subcategory</th>
													<th field="DISPLAY_ORDER" width="200px" align="left" sortable="true" >Display Order</th>
													<th field="NAME_ENG" width="500px" align="left" sortable="true" >Title</th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='help?id='+selected_row.PK_HELP;
					}
				}
			});
