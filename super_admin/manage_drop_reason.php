...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_DROP_REASON_MASTER WHERE PK_DROP_REASON_MASTER = '$_GET[id]' ");;
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor">Drop Reason </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="drop_reason" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										...
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_DROP_REASON_MASTER" width="150px" hidden="true" sortable="true" ></th>
													<th field="DROP_REASON" width="380px" align="left" sortable="true" >Drop Reason</th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='drop_reason?id='+selected_row.PK_DROP_REASON_MASTER;
					}
				}
			});
