...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_LEAD_SOURCE_MASTER WHERE PK_LEAD_SOURCE_MASTER = '$_GET[id]' ");;
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor">Lead Source </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="lead_source" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										...
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_LEAD_SOURCE_MASTER" width="150px" hidden="true" sortable="true" ></th>
													<th field="LEAD_SOURCE" width="250px" align="left" sortable="true" >Lead Source</th>
													<th field="LEAD_SOURCE_GROUP" width="250px" align="left" sortable="true" >Lead Group</th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='lead_source?id='+selected_row.PK_LEAD_SOURCE_MASTER;
					}
				}
			});
