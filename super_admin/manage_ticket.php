...
if($current_page != $_SESSION['PREVIOUS_PAGE']){
	$_SESSION['SORT_FIELD'] 	 = 'TICKET_NO';
...
if(isset($_GET['st']))
	$_SESSION['SRC_TXT_2'] = $_GET['st'];
if(isset($_GET['n']))
	$_SESSION['SRC_TXT_1'] = $_GET['n'];
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                <div class="row page-titles">
					...
					<div class="col-md-2 align-self-center text-right">
                       <select name="PK_TICKET_CATEGORY" id="PK_TICKET_CATEGORY" class="form-control" style="margin-top: 10px;" onchange="doSearch()" >
							...
							while (!$res_dep->EOF) { ?>
								<option value="<?=$res_dep->fields['PK_TICKET_CATEGORY']?>" <? if($res_dep->fields['PK_TICKET_CATEGORY'] == $_SESSION['SRC_TXT_3']) echo "selected"; ?> ><?=$res_dep->fields['TICKET_CATEGORY']?></option>
							<?	$res_dep->MoveNext();
							} 	?>
						</select>
					</div> 
					<div class="col-md-2 align-self-center text-right">
                       <select name="PK_TICKET_STATUS" id="PK_TICKET_STATUS" class="form-control" style="margin-top: 10px;" onchange="doSearch()" >
							...
							while (!$res_dep->EOF) { ?>
								<option value="<?=$res_dep->fields['PK_TICKET_STATUS']?>" <? if($res_dep->fields['PK_TICKET_STATUS'] == $_SESSION['SRC_TXT_2']) echo "selected"; ?> ><?=$res_dep->fields['TICKET_STATUS']?></option>
							<?	$res_dep->MoveNext();
							} 	?>
						</select>
					</div> 
					<div class="col-md-2 align-self-center text-right">
                        <input type="text" class="form-control" id="SEARCH" name="SEARCH" placeholder="&#xF002; <?=SEARCH?>"  style="font-family: FontAwesome" onkeypress="search(event)" value="<?=$_SESSION['SRC_TXT_1']?>" >
					</div>  
                    <div class="col-md-3 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
							<a href="ticket_excel" class="btn btn-info d-none d-lg-block m-l-15"> Export</a>
							<a href="ticket_overview" class="btn btn-info d-none d-lg-block m-l-15"> Overview</a>
								...
								<div class="row">
									<div class="col-md-12">
											<? if($_SESSION['SORT_FIELD'] != '')
												...
												$sort = '' ?>
											<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_ticket" toolbar="#tb" rownumbers="false" pagination="true" <?=$sort?> autoRowHeight="true"  pageNumber="<?=$_SESSION['PAGE']?>" pageSize="<?=$_SESSION['rows']?>" <?=$sort?> >
											<thead>
												<tr>
													...
													<th field="SCHOOL_NAME" width="150px" sortable="true" >School</th>
													...
													<th field="TICKET_CATEGORY" width="150px" sortable="true" align="left" >Category</th>
													...
													<th field="NAME" width="120px" sortable="true" ><?=CREATED_BY?></th>
													<th field="DUE_DATE" width="90px" sortable="true" ><?=DUE_DATE?></th>
													...
													<th field="CLOSED_DATE" width="120px" sortable="false" >Date Closed</th>
	...
	function doSearch(){
			jQuery(document).ready(function($) {
				$('#tt').datagrid('load',{
					...
					PK_TICKET_CATEGORY	: $('#PK_TICKET_CATEGORY').val(),
				});
			});	
		}
		function search(e){
