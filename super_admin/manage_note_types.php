...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_NOTE_TYPE_MASTER WHERE PK_NOTE_TYPE_MASTER = '$_GET[id]' ");;
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor"><? if($_GET['t'] == 1) echo "Student Note Types"; else echo "Student Event Types"; ?> </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="note_types?t=<?=$_GET['t']?>" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										...
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_NOTE_TYPE_MASTER" width="150px" hidden="true" sortable="true" ></th>
													<th field="DEPARTMENT" width="180px" align="left" sortable="true" >Department</th>
													<th field="NOTE_TYPE" width="700px" align="left" sortable="true" >
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='note_types?id='+selected_row.PK_NOTE_TYPE_MASTER+'&t=<?=$_GET['t']?>';
					}
				}
			});
