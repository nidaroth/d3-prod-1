...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_SESSION_MASTER WHERE PK_SESSION_MASTER = '$_GET[id]' ");;
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="session" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										...
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_SESSION_MASTER" width="150px" hidden="true" sortable="true" ></th>
													<th field="SESSION" width="700px" align="left" sortable="true" >Session</th>
													<th field="SESSION_ABBREVIATION" width="300px" align="left" sortable="true" >Session Abbreviation</th>
													<th field="COLOR" width="100px" align="center" sortable="true" >Color</th>
