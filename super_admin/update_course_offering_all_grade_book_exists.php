...
if(!empty($_POST)){
	...
	if($_POST['PK_ACCOUNT'] != '') {
		...
		$res_co_1 = $db->Execute("select PK_COURSE_OFFERING FROM S_COURSE, S_COURSE_OFFERING WHERE  S_COURSE_OFFERING.PK_COURSE = S_COURSE.PK_COURSE AND S_COURSE.PK_ACCOUNT = '$_POST[PK_ACCOUNT]' ");
		while (!$res_co_1->EOF) {
...
<head>
	...
	<title>Update All Course Offering If Grade Book Data Exists | <?=$title?></title>
</head>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Update All Course Offering If Grade Book Data Exists</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
							...
							<form class="floating-labels m-t-40" method="post" name="form1" id="form1" enctype="multipart/form-data" >
								<div class="p-20">
									...
									<div class="d-flex">
										...
										<div class="col-6 col-sm-6" >
											<b>Description:</b> For data conversion purposes only. Updates grades for ALL Course Offerings for an account using data from the Course Offering Grade Book. If Course Offering Grade Book is blank, the grade WILL NOT BE UPDATED.
											<br /><br />
