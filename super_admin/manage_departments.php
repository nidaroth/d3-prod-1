...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_DEPARTMENT_MASTER WHERE PK_DEPARTMENT_MASTER = '$_GET[id]' ");;
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="departments" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										...
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_DEPARTMENT_MASTER" width="150px" hidden="true" sortable="true" ></th>
													<th field="DEPARTMENT" width="780px" align="left" sortable="true" >Department</th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='departments?id='+selected_row.PK_DEPARTMENT_MASTER;
					}
				}
			});
