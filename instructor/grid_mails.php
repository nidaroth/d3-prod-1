...
$query = "SELECT Z_INTERNAL_EMAIL.PK_INTERNAL_EMAIL,PK_INTERNAL_EMAIL_RECEPTION,VIWED, Z_INTERNAL_EMAIL.INTERNAL_ID, SUBJECT, IF(PK_USER_TYPE = 2, CONCAT(S_EMPLOYEE_MASTER.FIRST_NAME,' ',S_EMPLOYEE_MASTER.LAST_NAME) , IF(PK_USER_TYPE = 3, CONCAT(S_STUDENT_MASTER.FIRST_NAME,' ',S_STUDENT_MASTER.LAST_NAME) , IF(PK_USER_TYPE = 1, CONCAT(S_EMPLOYEE_MASTER.FIRST_NAME,' ',S_EMPLOYEE_MASTER.LAST_NAME),'') )) AS NAMEZ_INTERNAL_EMAIL_RECEPTION.CREATED_ON ,Z_USER.PK_USER, Z_INTERNAL_EMAIL.CREATED_BY 
FROM 
Z_INTERNAL_EMAIL_RECEPTION ,Z_INTERNAL_EMAIL, Z_USER 
LEFT JOIN S_EMPLOYEE_MASTER ON S_EMPLOYEE_MASTER.PK_EMPLOYEE_MASTER = Z_USER.ID AND PK_USER_TYPE IN (1,2) 
