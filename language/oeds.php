...
if($_SESSION['PK_LANGUAGE'] == 1){
	//English
    define("OEDS_DOC_SETUP", "NY Occupational Education Data Statistics (OEDS) Setup");
	define("OEDS_CURRiCULUM_SETUP", "NY Occupational Education Data Statistics (OEDS) - Curriculum Setup");

	define("EXCLUDED_STUDENT_STATUS", "Excluded Student Status(es)");

	define("EXCLUDED_PROGRAM", "Excluded Programs");
	define("ADMISSION_STUDENT_STATUS", "Admission Student Status(es)");
	define("REGISTAR_STUDENT_STATUS", "Registar Student Status(es)");
	define("REQUESTED_ADDMISSION", "Requested Adminssion");
	...
	define("PLACEMENT_STATUS", "Placement Student Status");
