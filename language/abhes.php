...
if($_SESSION['PK_LANGUAGE'] == 1){
	//English
    define("ABHES_DOC_SETUP", "Accrediting Bureau of Health Education Schools (ABHES) Setup");
	...
	define("WITHDRWAL_DROP_STUDENT_STATUS", "Withdrawal/Drop Student Status(es)");
    ...
    define("RESULTS_PENDING", "Results Pending");
