	...
	<nav class="navbar top-navbar navbar-expand-md navbar-dark">
		<div class="navbar-header">
			<a class="navbar-brand" href="index">
				<b>
					<? $res_logo = $db->Execute("SELECT LOGO, _1098T_TAX_FORM, _480G_TAX_FORM, ENABLE_INTERNAL_MESSAGE FROM Z_ACCOUNT WHERE PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]'"); //ticket #967 | DIAM 407 ?>
	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				...
				<? if($_SESSION['FINANCIAL_AID_AWARDS'] == 1 || $_SESSION['PAYMENT_SCHEDULE'] == 1 || $_SESSION['STUDENT_LEDGER'] == 1 || $res_logo->fields['_1098T_TAX_FORM'] == 1 || $res_logo->fields['_480G_TAX_FORM'] == 1){ //Ticket # 1321 ?>
				<!-- Ticket #1048 -->
				<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-dollar-sign"></i><span class="hide-menu"><?=MNU_FINANCE ?> </span></a>
					<ul aria-expanded="false" class="collapse">
						...
						<? }
						if($res_logo->fields['_480G_TAX_FORM'] == 1){ ?>
						<li ><a href="_480G" ><?=MNU_480G_TAX_FORM?></a></li>
						<? }
