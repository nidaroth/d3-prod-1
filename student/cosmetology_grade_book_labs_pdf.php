...
$txt .= '<div style="border-top: 2px #c0c0c0 solid" ></div>
		<table border="0" cellspacing="0" cellpadding="3" width="100%">
			<thead>
				<tr>
					<td width="40%" style="border-bottom:1px solid #000;" ><b>'.LAB_DESCRIPTION.'</b></td>
					<td width="20%" style="border-bottom:1px solid #000;" align="right" ><b>'.REQUIRED_SESSIONS.'</b></td>
					<td width="20%" style="border-bottom:1px solid #000;" align="right" ><b>'.COMPLETED_SESSIONS.'</b></td>
					<td width="20%" style="border-bottom:1px solid #000;" align="right" ><b>'.REMAINING_SESSIONS.'</b></td>
				</tr>
			</thead>';
...
while (!$res_grade->EOF) { 
	...
	$txt .= '<tr >
				<td width="40%" >'.$res_grade->fields['DESCRIPTION'].'</td>
				<td width="20%" align="right">'.number_format_value_checker($res_grade->fields['SESSION_REQUIRED'],2).'</td>
				<td width="20%" align="right" >'.number_format_value_checker($res_grade->fields['SESSION_COMPLETED'],2).'</td>
				<td width="20%" align="right" >'.number_format_value_checker(($res_grade->fields['SESSION_REQUIRED'] - $res_grade->fields['SESSION_COMPLETED']),2).'</td>
			</tr>';
...
$file_name = 'Cosmetology Grade Book Labs.pdf';
/*
if($browser == 'Safari')
