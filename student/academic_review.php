            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor"><?=ACADEMIC_REVIEW_PAGE_TITLE?></h4>
                    </div>
                </div>	
								...
								<div class="row">
									<div class="col-md-2">
										<!--<select id="t" name="t" class="form-control" >
											...
											<option value="-1" <? if($_GET['t'] == -1) echo "selected"; ?> >Transfer</option>
									...
									<div class="col-md-4">
										...
										<a href="../school/student_transcript_list_pdf" class="btn waves-effect waves-light btn-info" ><?=PDF?></a>
									</div>
								</div>
										...
										<table data-toggle="table" data-mobile-responsive="true" class="table-striped" >
											<thead>
												<tr>
													...
													<th ><div style="padding-top: 11px;width:100%;text-align:right" ><?=UNITS_ATTEMPTED?></div></th>
													<th ><div style="padding-top: 11px;width:100%;text-align:right" ><?=UNITS_COMPLETED?></div></th>
												</tr>
											</thead>
											<tbody>
												...
												//if($_GET['t'] == -1 || $_GET['t'] == '') {
													$cond = "";
													if($_GET['t'] != '') {
														$cond = " AND S_STUDENT_CREDIT_TRANSFER.PK_STUDENT_ENROLLMENT = '$_GET[t]' ";
														$_SESSION['eid'] = $_GET['t'];
													}
													...
													$res_course = $db->Execute("SELECT 
																				  ...
																				  WHERE 
																					PK_STUDENT_MASTER = '$_SESSION[PK_STUDENT_MASTER]' $cond 
																				  ORDER BY 
													...
													while (!$res_course->EOF) {  
														...
														$UNITS_ATTEMPTED		= $res_course->fields['UNITS']; 
														$c_in_num_grade_tot		+= $res_course->fields['TC_NUMERIC_GRADE'];  //Ticket # 1240 ?>
														<tr >
															<td>
																Transfer
															</td>
															<td >
																<?=$res_course->fields['COURSE_CODE'] ?>
															</td>
															<td >
															...
															<? if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 1 || $res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3){ ?>
															<td>
																<?=$res_course->fields['GRADE']; ?>
															</td>
															<? } 
															if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 2 || $res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3){ ?>
															<td>
																<div style="text-align:right" >
																	<?=$res_course->fields['TC_NUMERIC_GRADE']; ?>
																</div>
															</td>
															<? } ?>
															<!-- Ticket # 1240 -->
															...
															<td>
																<div style="padding-top: 11px;width:100%;text-align:right" >
																	...
																	$c_in_att_tot += $UNITS_ATTEMPTED; 
																	
																	if($res_course->fields['CALCULATE_GPA'] == 1) {
																		$c_in_cu_gnu += $res_course->fields['UNITS'] * $res_course->fields['NUMBER_GRADE']; 
																		$c_in_cu_tot += $UNITS_ATTEMPTED;
																		
																		if($res_tc->fields['UNITS_COMPLETED'] == 1)
																			$c_in_cu_tot += $res_course->fields['UNITS'];
															...
															<td>
																<div style="padding-top: 11px;width:100%;text-align:right" >
																	<? if($res_course->fields['UNITS_COMPLETED'] == 1) {
																		$c_in_comp_tot += $UNITS_ATTEMPTED;
																		echo $UNITS_ATTEMPTED;
																	} else
																		echo "0.00";
																	
																	if($res_course->fields['UNITS_IN_PROGRESS'] == 1) //ticket #1152
																		$c_in_prog_tot += $UNITS_ATTEMPTED; ?>
																</div>
															</td>
														</tr>
													<?	$res_course->MoveNext();
												...
												$res_course = $db->Execute("SELECT 
																			  ...
																			  WHERE 
																				S_STUDENT_COURSE.PK_STUDENT_MASTER = '$_SESSION[PK_STUDENT_MASTER]' $cond 
																			  ORDER BY 
																				BEGIN_DATE ASC, 
												...
												while (!$res_course->EOF) {  
													...
													$PK_STUDENT_ENROLLMENT  = $res_course->fields['PK_STUDENT_ENROLLMENT'];  
													$FINAL_GRADE  			= $res_course->fields['FINAL_GRADE']; 
													$UNITS_ATTEMPTED		= $res_course->fields['COURSE_UNITS']; 
													...
													<tr >
														...
														<td>
															<div style="text-align:right" >
																<?=$res_course->fields['NUMERIC_GRADE']; ?>
															</div>
														</td>
														<? } ?>
														<!-- Ticket # 1240 -->
														...
														<td>
															<div style="padding-top: 11px;width:100%;text-align:right" >
																...
																/* Ticket # 1152 */
																if($res_course->fields['CALCULATE_GPA'] == 1) {
																	$c_in_cu_gnu += $UNITS_ATTEMPTED * $res_course->fields['NUMBER_GRADE']; 
														...
														<td>
															<div style="padding-top: 11px;width:100%;text-align:right" >
																<? if($res_course->fields['UNITS_COMPLETED'] == 1) { //Ticket # 1152
																	...
																	echo "0.00";
																if($FINAL_GRADE != ''){ 
																	//echo number_format_value_checker(($UNITS_ATTEMPTED * $res_course->fields['FINAL_GRADE_NUMBER_GRADE']),2);
												...
												<tr>
													...
													<? } 
													if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 2 || $res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3){ ?>
													<td><div style="padding-top: 11px;width:100%;text-align:right" ><?=number_format_value_checker($c_in_num_grade_tot,2)?></div></td>
													<? } ?>
														
													<td><div style="padding-top: 11px;width:100%;text-align:right" ><?=number_format_value_checker($c_in_att_tot,2)?></div></td>
													<td><div style="padding-top: 11px;width:100%;text-align:right" ><?=number_format_value_checker($c_in_comp_tot,2)?></div></td>
												</tr>
												<tr>
													<td <? if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3){ ?> colspan="5" <? } else { ?> colspan="4" <? } ?> ></td>
													<td><div style="padding-top: 11px;width:100%;text-align:right" ><?=GPA?></div></td>
													<td><div style="padding-top: 11px;width:100%;text-align:right" ><?=number_format_value_checker(($summation_of_gpa/$summation_of_weight),2) ?></div></td>
												</tr>
												<!-- Ticket # 1240 -->
											</tbody>
										</table>
