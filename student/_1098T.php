	...
	if($_POST['FORMAT'] == 1){    // This block for student ledger pdf  DIAM-11
						...
						<tr>
							...
							<td width="40%" valign="top" >
								<table width="100%" >
									...
									<tr>
										<td width="100%" align="right" style="font-size:13px;" >Between: 01/01/'.$CALENDAR_YEAR.' and 12/31/'.$CALENDAR_YEAR.'</td>
									</tr>
								</table>
							</td>
						</tr>
		...
		$footer = '<table width="100%" >
						<tr>
							...
							<td width="33%" valign="top" style="font-size:10px;" align="center" >ACCT1098'.$CALENDAR_YEAR.'</td>
		...
		$res = $db->Execute("CALL ACCT1098$CALENDAR_YEAR(".$_SESSION['PK_ACCOUNT'].",".$_SESSION['PK_USER'].",'".$PK_1098T_EIN."', 'Student 1098T Ledger',$PK_STUDENT_MASTER)");
		if($res->fields['ERROR']){
		...
		$res = $db->Execute("CALL ACCT1098$CALENDAR_YEAR(".$_SESSION['PK_ACCOUNT'].",0,'".$PK_1098T_EIN."', 'Student 1098T Form',$PK_STUDENT_MASTER)");
		if($res->fields['ERROR']){
			$report_error=$res->fields['ERROR'];
		}else{
		while (!$res->EOF) {
									...
									<tr>
										...
										<td width="19%" style="border-top:1px solid #000;border-left:1px solid #000;border-right:1px solid #000;" >
											<table border="0" cellspacing="0" cellpadding="3" width="100%" >
												...
												<tr>
													<td width="100%" align="center" >
														<b style="font-size:80px;line-height:6px" >'.$CALENDAR_YEAR.'</b>
													</td>
												</tr>
												<tr>
													<td width="100%" align="center" >
						...
						<tr>
							<td width="51%" >
								...
								<div style="line-height:5px" >
									...
									<b>Box 1.</b> Shows the total payments received by an eligible educational institution in '.$CALENDAR_YEAR.' from any source for qualified tuition and related expenses less any reimbursements or refunds made during '.$CALENDAR_YEAR.' that relate to those payments received during '.$CALENDAR_YEAR.'.<br />
									
									<b>Box 2.</b> Reserved for future use.<br />
									
									<b>Box 3.</b> Reserved for future use.<br />
									
									<b>Box 4.</b> Shows any adjustment made by an eligible educational institution for a prior year for qualified tuition and related expenses that were reported on a prior year Form 1098-T. This amount may reduce any allowable education credit that you claimed for the prior year (may result in an increase in tax liability for the year of the refund). See "recapture" in the index to Pub. 970 to report a reduction in your education credit or tuition and fees deduction.<br /><br /><br /><br /><br /><br /><br /><br />
									<div style="font-size:32px;font" >
									'.$res->fields['Sort'].'<br />
							...
							<td width="48%" >
								...
								<div style="line-height:5px" >
									...
									<b>Box 7.</b> Shows whether the amount in box 1 includes amounts for an academic period beginning January–March '.($CALENDAR_YEAR + 1).'. See Pub. 970 for how to report these amounts.<br />
											...
											<div class="d-flex">
												<div class="col-12 col-sm-12 form-group">
													...
													<select id="CALENDAR_YEAR" name="CALENDAR_YEAR" class="form-control required-entry" onchange="show_btn(this.value)" >
														...
														$FN_CALENDAR_YEARS_current	= explode(',' , $res_current->fields['_1098T_CALENDAR_YEARS']);//DIAM-1494 Added CALENDAR YEARS
