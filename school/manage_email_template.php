...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM S_EMAIL_TEMPLATE WHERE PK_EMAIL_TEMPLATE = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' ");
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor"><?=EMAIL_TEMPLATE_PAGE_TITLE?> </h4>
                    </div>
