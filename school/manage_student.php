...
if($current_page != $_SESSION['PREVIOUS_PAGE'] || $_SESSION['top_t'] != $_GET['t'] || $_GET['clear'] == 1){
	...
	$_SESSION['SRC_PK_STUDENT_GROUP'] 		= $res_s->fields['SRC_PK_STUDENT_GROUP'];
	$_SESSION['SRC_PK_CAMPUS_PROGRAM'] 		= $res_s->fields['PK_CAMPUS_PROGRAM']; // DIAM - 62, Clear Filter Does Not Clear Student Group
                            ...
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12" >
										...
										url="grid_student?t=<?=$_GET['t']?>" loadMsg="Processing, please wait..." toolbar="#tb" pagination="true"  pageNumber="<?=$_SESSION['PAGE']?>" pageSize="<?=$_SESSION['rows']?>" <?=$sort?>  data-options="onClickCell: function(rowIndex, field, value){
