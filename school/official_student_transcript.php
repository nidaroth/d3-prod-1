...
if(!empty($_POST)){
	//print_r($_POST);exit;
		...
		header("location:official_student_transcript_pdf?id=".$stud_id.'&uno=0&exclude_tc='.$_POST['EXCLUDE_TRANSFERS_COURSE'].'&inc_att='.$_POST['DISPLAY_ATTENDNACE']);	
		exit;
}
...
<head>
	...
	<title><?=MNU_OFFICIAL_STUDENT_TRANSCRIPT?> | <?=$title?></title>
                 ...
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">
							<?=MNU_OFFICIAL_STUDENT_TRANSCRIPT?>
						</h4>
                    </div>
                </div>
									...
									<div id="student_div" >
											...
											<div class="col-md-12">
												<? if($_SESSION['SORT_FIELD'] != '')
													...
													$sort = '' ?>
												<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" nowrap="false" autoRowHeight="true" url="grid_official_student_transcript_report"
