...
<head>
	...
	<title><?=MNU_MOODLE.' - '.MNU_SEND_COURSE_OFFERING_INSTRUCTOR_RESULT ?> | <?=$title?></title>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><?=MNU_MOODLE.' - '.MNU_SEND_COURSE_OFFERING_INSTRUCTOR_RESULT ?> </h4>
                    </div>
                </div>
										...
										<div class="col-12">
											<div class="card">
												<div class="card-body">
													<div class="row">
														<div class="col-md-12">
															<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_send_course_offering_instructor_ethink_result?BATCH_ID=<?=$_GET['id']?>"
