						...
						<table border="0" cellspacing="0" cellpadding="3" width="100%" >';
							...
							while (!$res_test_type->EOF) { 
									...
									$txt .= '<tr>
										...
										$txt .= '<tr>
												...
												$txt .= '<td width="10.71%" style="border-top:1px solid #000;" ><b style="font-size:22px" >'.$sub_tot_session_req.'</b></td>
													...
													<td width="10.71%" style="border-top:1px solid #000;" ><b style="font-size:22px" >'.number_format_value_checker(($sub_tot_point_com / $sub_tot_point_req * 100), 2).'</b></td>
												</tr>';
								...
								$txt .= '<tr>
										...
										$txt .= '<td width="10.71%" style="border-top:1px solid #000;" ><b style="font-size:22px" >'.$type_tot_session_req.'</b></td>
												...
												<td width="10.71%" style="border-top:1px solid #000;" ><b style="font-size:22px" >'.number_format_value_checker(($type_tot_point_com / $type_tot_point_req * 100), 2).'</b></td>
											</tr>';
							...
							$txt .= '<tr>
								...
								$txt .= '<td width="10.71%" style="border-top:1px solid #000;" ><b style="font-size:22px" >'.$tot_session_req.'</b></td>
										...
										<td width="10.71%" style="border-top:1px solid #000;" ><b style="font-size:22px" >'.number_format_value_checker(($tot_point_com / $tot_point_req * 100), 2).'</b></td>
									</tr>';
...
if($_GET['download_via_js'] == 'yes'){
	$outputFileName = 'temp/Program_Grade_Book_Progress_Report_Card.pdf';
