                    ...
                    <div class="card">
                        <div class="card-body">
							...
							<div id="schedule_summary" >
								...
								$res_course_schedule = $db->Execute("select S_COURSE.HOURS, COURSE_CODE,ROOM_NO,ROOM_DESCRIPTION , S_STUDENT_COURSE.PK_STUDENT_COURSE, S_COURSE_OFFERING_SCHEDULE.START_DATE, S_COURSE_OFFERING_SCHEDULE.END_DATE from 
								...
								LEFT JOIN S_COURSE ON S_COURSE.PK_COURSE = S_STUDENT_COURSE.PK_COURSE 
							...
							<div id="schedule_detail" style="display:none"  >
								...
								<hr />
								<? $res_course_schedule = $db->Execute("select IF(SCHEDULE_DATE != '0000-00-00', DATE_FORMAT(SCHEDULE_DATE,'%m/%d/%Y'),'') AS SCHEDULE_DATE, START_TIME, END_TIME, S_STUDENT_SCHEDULE.HOURS, ROOM_NO, COURSE_CODE, ROOM_DESCRIPTION from 
