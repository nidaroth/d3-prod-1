                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_title_iv_recipients_by_category_setup"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_TITLE_IV_RECIPIENTS_CATEGORY" width="150px" hidden="true" sortable="true" ></th>
													<th field="CODE" width="270px" align="left" sortable="true" ><?=TITLE_IV_RECIPIENTS_CATEGORY ?></th>
													<th field="LEDGER_CODES" width="1000px" align="left" sortable="true" ><?=LEDGER_CODES?></th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='title_iv_recipients_by_category_setup?id='+selected_row.PK_TITLE_IV_RECIPIENTS_CATEGORY;
					}
				}
			});
