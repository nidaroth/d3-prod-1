...
class MYPDF extends TCPDF {
	public function Header() {
		...
		$this->SetX(163);
		$this->SetTextColor(000, 000, 000);
		$this->Cell(55, 8, "Duplicate SSN", 0, false, 'L', 0, '', 0, false, 'M', 'L');
...
$txt .= '<table border="0" cellspacing="0" cellpadding="3" width="100%">
			<thead>
				<tr>
					<td width="15%" style="border-top:1px solid #000;border-bottom:1px solid #000;" >SSN</td>
...
while (!$res_ssn->EOF) {
	...
	while (!$res_type->EOF){
		$txt 	.= '<tr>
					...
					<td width="20%" >'.$res_type->fields['STUDENT_STATUS'].'</td>
