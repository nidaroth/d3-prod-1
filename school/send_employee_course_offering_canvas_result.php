...
<head>
	...
	<title><?=MNU_SEND_COURSE_OFFERING_INSTRUCTOR_RESULT ?> | <?=$title?></title>
</head>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><?=MNU_SEND_COURSE_OFFERING_INSTRUCTOR_RESULT ?> </h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
