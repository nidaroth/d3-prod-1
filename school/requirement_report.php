...
if(!empty($_POST)){
	...
	if($_POST['PK_STUDENT_ENROLLMENT'] != '') {
		...
		if($_POST['FORMAT'] == 1)
			header("location:requirement_pdf?eid=".$PK_STUDENT_ENROLLMENT."&t=2");
		else if($_POST['FORMAT'] == 2)
			header("location:requirement_excel?eid=".$PK_STUDENT_ENROLLMENT."&t=2");
...
<head>
	...
	<title><?=MNU_REQUIREMENTS ?> | <?=$title?></title>
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><?=MNU_REQUIREMENTS?></h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
										...
										<div id="student_div" >
											...
											<div class="col-md-12">
												<? if($_SESSION['SORT_FIELD'] != '')
													...
													$sort = '' ?>
												<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" nowrap="false" autoRowHeight="true" url="grid_requirement_report"
	...
	<script type="text/javascript">
		...
		function search_old(){
			jQuery(document).ready(function($) {
				var data  = 'PK_STUDENT_GROUP='+$('#PK_STUDENT_GROUP').val()+'&PK_TERM_MASTER='+$('#PK_TERM_MASTER').val()+'&PK_CAMPUS_PROGRAM='+$('#PK_CAMPUS_PROGRAM').val()+'&PK_STUDENT_STATUS='+$('#PK_STUDENT_STATUS').val()+'&PK_COURSE='+$('#PK_COURSE').val()+'&PK_COURSE_OFFERING='+$('#PK_COURSE_OFFERING').val()+'&show_check=1&show_count=1'; //Ticket # 1213
				var value = $.ajax({
