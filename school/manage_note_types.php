...
if($_GET['act'] == 'del')	{
	$res_check1 = $db->Execute("select PK_STUDENT_NOTES from S_STUDENT_NOTES WHERE PK_NOTE_TYPE = '$_GET[id]' ");
	if($res_check1->RecordCount() == 0 )
		$db->Execute("DELETE FROM M_NOTE_TYPE WHERE PK_NOTE_TYPE = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_NOTE_TYPE_MASTER = 0");
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor"><? if($_GET['t'] == 1) echo NOTE_TYPE_PAGE_TITLE; else if($_GET['t'] == 2) echo EVENT_TYPE_PAGE_TITLE; ?> </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="note_types?t=<?=$_GET['t']?>" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_note_types?t=<?=$_GET['t']?>"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_NOTE_TYPE" width="150px" hidden="true" sortable="true" ></th>
													<th field="DEPARTMENT" width="180px" align="left" sortable="true" ><?=DEPARTMENT?></th>
													<th field="NOTE_TYPE" width="300px" align="left" sortable="true" >
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='note_types?id='+selected_row.PK_NOTE_TYPE+'&t=<?=$_GET['t']?>';
					}
				}
			});
	...
	function conf_delete(val,id){
		if(val == 1)
			window.location.href = 'manage_note_types?act=del&t=<?=$_GET['t']?>&id='+$("#DELETE_ID").val();
		else
