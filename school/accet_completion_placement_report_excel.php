...
include '../global/excel/Classes/PHPExcel/IOFactory.php';
        ...
        $file_name 		= 'ACCET_Doc 28.1 Completion & Placement Statistics.xlsx';
        ...
        $line 	= 1;	
        $index 	= -1;
        $res = $db->Execute("CALL ACCET10001(".$_SESSION['PK_ACCOUNT'].", '".$PK_CAMPUS."','".$ST."','".$ET."', 'Completion and Placement Statistics')");	
