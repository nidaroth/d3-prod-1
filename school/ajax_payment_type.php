...
if($res_type->fields['TYPE'] == 1){ ?>
	<select id="PK_AR_PAYMENT_TYPE_<?=$_REQUEST['count_1']?>" name="PK_AR_PAYMENT_TYPE[]" class="form-control" style="width:100px;" onchange="button_enable_disable(this.value);" >
		<option value="" ></option>
...
<? } else { ?>
	<select id="PK_AR_FEE_TYPE_<?=$_REQUEST['count_1']?>" name="PK_AR_FEE_TYPE[]" class="form-control" style="width:100px;" >
		<option value="" ></option>
