...
tr { page-break-inside: avoid; }
	...
	$header_path = create_html_file('header_attendance_roster_new.html', $header_cont, "invoice");
	$content_path = create_html_file('content_attendance_roster_new.html', $html_body_cont, "invoice");
	$footer_path = create_html_file('footer_attendance_roster_new.html', $footer_cont, "invoice");
	...
	unlink('../school/temp/invoice/header_attendance_roster_new.html');
	unlink('../school/temp/invoice/content_attendance_roster_new.html');
	unlink('../school/temp/invoice/footer_attendance_roster_new.html');
	exit;
}
