...
if(!empty($_POST)){
	//Ticket # 1187
	header("location:student_transcript_pdf?id=".implode(",",$_POST['PK_STUDENT_MASTER']).'&uno='.$_GET['uno'].'&exclude_tc='.$_POST['EXCLUDE_TRANSFERS_COURSE'].'&inc_att='.$_POST['DISPLAY_ATTENDNACE']);	
	exit;
}
...
<head>
	...
	<title><?=STUDENT_TRANSCRIPT?> | <?=$title?></title>
	<style>
