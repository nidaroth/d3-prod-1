...
class MYPDF extends TCPDF {
    public function Header() {
		...
		$this->SetTextColor(000, 000, 000);
		$this->SetX(218);
		$this->Cell(55, 8, 'Send Enrollments', 0, false, 'L', 0, '', 0, false, 'M', 'L');
...
$txt = '<table border="0" cellspacing="0" cellpadding="3" width="100%">
			<thead>
				<tr>
					...
					<td width="10%" style="border-bottom:1px solid #000;" ><b>'.COURSE.'</b></td>
					<td width="10%" style="border-bottom:1px solid #000;" ><b>'.SESSION.'</b></td>
					<td width="10%" style="border-bottom:1px solid #000;" ><b>'.LMS_CODE.'</b></td>
					<td width="10%" style="border-bottom:1px solid #000;" ><b>'.INSTRUCTOR.'</b></td>
					<td width="10%" style="border-bottom:1px solid #000;" ><b>'.STUDENT.'</b></td>
			...
			while (!$res_type->EOF) {
				...
				$txt .= '<tr>
							<td width="10%">'.$res_type->fields['CAMPUS_CODE'].'</td>
							<td width="7%">'.$BEGIN_DATE.'</td>
							<td width="10%">'.$res_type->fields['COURSE_CODE'].'</td>
							<td width="10%">'.$res_type->fields['SESSION'].'</td>
							<td width="10%">'.$res_type->fields['LMS_CODE'].'</td>
							<td width="10%">'.$res_type->fields['INSTRUCTOR_NAME'].'</td>
