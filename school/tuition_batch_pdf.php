...
class MYPDF extends TCPDF {
	public function Header() {
		...
		$this->SetTextColor(000, 000, 000);
		$this->SetX(250);
		$this->Cell(55, 8, "Tuition Batch", 0, false, 'L', 0, '', 0, false, 'M', 'L');
...
$txt .= '<table border="0" cellspacing="0" cellpadding="2" width="100%">
		<thead>
			<tr>
				...
				<td width="25%" style="border-bottom:1px solid #000;text-align:left;">
					<b><i>'.TYPE.'</i></b>
				</td>
	...
	while (!$res->EOF) { 
		...
		<tr>
						...
						<td width="10%" align="left">'.$TERM_MASTER.'</td>
