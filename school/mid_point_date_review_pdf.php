...
class MYPDF extends TCPDF {
    public function Header() {
		...
		$this->SetTextColor(000, 000, 000);
		$this->SetX(145);
		$this->Cell(55, 8, "Mid Point Date Review", 0, false, 'L', 0, '', 0, false, 'M', 'L');
...
foreach($PK_STUDENT_ENROLLMENTS as $PK_STUDENT_ENROLLMENT) {
	...
	$txt = '<table border="0" cellspacing="0" cellpadding="2" width="100%">
			...
			$res = $db->Execute("call REGR10101('Graduation50', ".$PK_STUDENT_ENROLLMENT.", 'REPORT')");
			while (!$res->EOF) {
...
$file_name = 'Mid Point Date Review.pdf';
/*
if($browser == 'Safari')
