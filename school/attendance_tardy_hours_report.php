...
if(!empty($_POST)){
	...
	if($_POST['FORMAT'] == 1)
		header("location:attendance_tardy_hours_pdf?st=".$_POST['START_DATE'].'&et='.$_POST['END_DATE']);
	else if($_POST['FORMAT'] == 2)
		header("location:attendance_tardy_hours_excel?st=".$_POST['START_DATE'].'&et='.$_POST['END_DATE']);
...
<head>
	...
	<title><?=MNU_ATTENDANCE_TARDY_HOURS?> | <?=$title?></title>
</head>
