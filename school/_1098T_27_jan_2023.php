...
if(!empty($_POST)){
	...
	if($_POST['FORMAT'] == 1){    // This block for student ledger pdf  DIAM-11
		...
		$line 	= 1;	
		$index 	= -1;	
		$res = $db->Execute("CALL ACCT10982022(".$_SESSION['PK_ACCOUNT'].",0,".$_POST['PK_1098T_EIN'].", 'Export Data for Review',$PK_STUDENT_MASTER)");
		...
		$line 	= 1;	
		$index 	= -1;	
		$res = $db->Execute("CALL ACCT10982022(".$_SESSION['PK_ACCOUNT'].",0,".$_POST['PK_1098T_EIN'].", 'Student 1098T ERROR REPORT',$PK_STUDENT_MASTER)");
										...
										<div class="col-6 col-sm-6 ">
											...
											<div class="d-flex">
												<div class="col-12 col-sm-12 form-group">
													<select id="PK_1098T_EIN" name="PK_1098T_EIN" class="form-control required-entry" onchange="get_eid_detail(this.value)" >
														...
														while (!$res_type->EOF) { ?>
															<option value="<?=$res_type->fields['PK_1098T_EIN']?>"  ><?=$res_type->fields['EIN_NO'] ?></option>
														<?	$res_type->MoveNext();
														} ?>
													</select>
													<span class="bar"></span> 
											...
											<div class="d-flex">
												...
												<div class="col-3 col-sm-3 focused">
													<button type="button" onclick="submit_form(4)" class="btn waves-effect waves-light btn-info"><?=EXCEL?></button>
												</div>
											</div>
											<br /><br />
											<div class="d-flex">
											...
											<div class="d-flex">
												...
												<div class="col-3 col-sm-3 focused">
													<button type="button" onclick="submit_form(5)" class="btn waves-effect waves-light btn-info"><?=EXCEL?></button>
												</div>
											</div>
											...
											<div class="d-flex">
												...
												<div class="col-6 col-sm-6 focused">
													<button type="button" onclick="submit_form(3)" class="btn waves-effect waves-light btn-info" disabled id="CREATE_ELECTRONIC_FILE_BTN" ><?=EXPORT?></button>
													<span id="CREATE_ELECTRONIC_FILE_SPAN" >Available in March</span>
												</div>
											</div>
											<br /><br />
