<?php 
 ...
 $grade_cunt = 1; 
 $result1 = $db->Execute("SELECT PK_COURSE_OFFERING_GRADE FROM S_COURSE_OFFERING_GRADE_HISTROY WHERE PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_COURSE_OFFERING = '$id' AND `CREATED_ON` = '$last_date' ORDER BY GRADE_ORDER ASC "); //Ticket #1290
...
if($PK_COURSE_OFFERING_GRADE == '') {
	...
	$result = $db->Execute("SELECT * FROM S_COURSE_OFFERING_GRADE_HISTROY WHERE PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_COURSE_OFFERING_GRADE = '$PK_COURSE_OFFERING_GRADE' AND `CREATED_ON` = '$last_date' ");
