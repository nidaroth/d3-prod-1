...
/*Appends header secton into body , use only for testing 
			...
			while(!$students->EOF){
				...
				<td width='25%' align='left' style='border-bottom : 1px solid #dee2e6; padding-top : 5px; height:70px;'>$NAME</td>
				<td width='20%' align='left' style='border-bottom : 1px solid #dee2e6;  padding-top : 5px;height:70px;'>$ID</td>
				<td width='25%' align='left' style='border-bottom : 1px solid #dee2e6;  padding-top : 5px;height:70px;'>_________________________</td>
				<td width='25%' align='left' style='border-bottom : 1px solid #dee2e6;  padding-top : 5px;height:70px;'>_________________________</td>
				<td width='25%' align='left' style='border-bottom : 1px solid #dee2e6;  padding-top : 5px;height:70px;'>_________________________</td>
				</tr>
			...
			// if (!empty($PK_STUDENT_ENROLLMENTS) && !empty($PK_STUDENT_COURSES)) {
				...
				while (strtotime($DATE_ITERATOR) <= strtotime($END_DATE)) {
					...
					if (check_valid_week($DATE_ITERATOR, $PK_STUDENT_ENROLLMENTS, $PK_STUDENT_COURSES)) {
						...
						<tr>
						<td width='25%' align='left' style='border:none !important'  ><b style='font-size : 14px'>Student</b> </td>
						<td width='20%' align='left' style='border:none !important'  ></td>
						<td width='25%' align='left'  style='border:none !important' ><b style='font-size : 14px'>Student Signature</b></td>
						<td width='25%' align='left'  style='border:none !important' ><b style='font-size : 14px'>Time-In
						<td width='25%' align='left'  style='border:none !important' ><b style='font-size : 14px'>Time-Out</b></td>
						</tr>
						".$student_table_static."
						<tr>
						<td width='25%' align='left'  ><div style='width : 70px ; height:70px;'> </div> </td>
...
function invoice_pdf_custom_header()
{
	...
	<table width="100%" >
			<tr>
				...
				<table width="100%" >
									<tr>
										<td width="100%" align="right" style="font-size:22px;border-bottom:1px solid #000;font-style: italic;font-family:helvetica;font-weight:normal;padding-top : 20px;text-align:right !important" >Daily Attendance Signature Sheet</td>
									</tr>
...
foreach ($JAVASCRIPT_COURSE_OFFERING_HEADERS as $course_offering => $header_html_content) {
	...
	$header_path = create_html_file('header_attendance_daily_attendance_signature_sheet.html', $header_cont, "invoice");
	$footer_path = create_html_file('footer_attendance_daily_attendance_signature_sheet.html', $footer_cont, "invoice");
	...
	unlink('../school/temp/invoice/header_attendance_daily_attendance_signature_sheet.html');
	unlink('../school/temp/invoice/footer_attendance_daily_attendance_signature_sheet.html');
	exit;
}
