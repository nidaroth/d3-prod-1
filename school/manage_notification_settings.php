...
if($_GET['act'] == 'del')	{
	$res_check1 = $db->Execute("select PK_NOTIFICATION from Z_NOTIFICATION WHERE PK_EVENT_TEMPLATE = '$_GET[id]' ");
	if($res_check1->RecordCount() == 0  )
		$db->Execute("DELETE FROM S_EVENT_TEMPLATE WHERE PK_EVENT_TEMPLATE = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' ");
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="notification_settings" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_notification_settings"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_EVENT_TEMPLATE" width="150px" hidden="true" sortable="true" ></th>
													<th field="EVENT_TYPE" width="600px" align="left" sortable="true" ><?=EVENT_TYPE?></th>
													<th field="CAMPUS" width="600px" align="left" sortable="true" ><?=CAMPUS?></th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='notification_settings?id='+selected_row.PK_EVENT_TEMPLATE;
					}
				}
			});
	...
	function conf_delete(val,id){
		if(val == 1)
			window.location.href = 'manage_notification_settings?act=del&id='+$("#DELETE_ID").val();
		else
