...
<head>
	...
	<title><?=MNU_MOODLE.' - '.MNU_SEND_STUDENT_ENROLLMENTS_RESULT ?> | <?=$title?></title>
	<style>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><?=MNU_MOODLE.' - '.MNU_SEND_STUDENT_ENROLLMENTS_RESULT ?> </h4>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="floating-labels m-t-40" method="post" name="form1" id="form1" enctype="multipart/form-data">
									...
									url="grid_send_student_course_offering_ethink_result?BATCH_ID=<?=$_GET['id']?>" toolbar="#tb" pagination="true" pageSize = 25 >
										<thead>
											<tr>
