...
function program_grade_book_transcript($PK_STUDENT_MASTERS,$one_stud_per_pdf, $report_name){
	...
	foreach($PK_STUDENT_MASTER_ARR as $key => $PK_STUDENT_MASTER) {
		...
		if($ENROLLMENT_ID_ARR[$key] != '')
			$en_cond1 = " AND S_STUDENT_ENROLLMENT.PK_STUDENT_ENROLLMENT IN ($ENROLLMENT_ID_ARR[$key]) ";
		else
		...
		if($ENROLLMENT_ID_ARR[$key] != '')
			$PK_STUDENT_ENROLLMENT = $ENROLLMENT_ID_ARR[$key];
		else
	...
	$res_attended_all = $db->Execute("SELECT IFNULL(SUM(ATTENDANCE_HOURS),0) AS ATTENDED_HOUR FROM S_STUDENT_ATTENDANCE,S_STUDENT_SCHEDULE WHERE S_STUDENT_SCHEDULE.PK_STUDENT_MASTER = '$PK_STUDENT_MASTER' AND S_STUDENT_SCHEDULE.PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND S_STUDENT_SCHEDULE.PK_STUDENT_SCHEDULE = S_STUDENT_ATTENDANCE.PK_STUDENT_SCHEDULE AND COMPLETED = 1 AND S_STUDENT_SCHEDULE.PK_STUDENT_ENROLLMENT IN ($PK_STUDENT_ENROLLMENT) $date_cond1 AND S_STUDENT_ATTENDANCE.PK_ATTENDANCE_CODE IN ($present_att_code)  ");
		...
		$txt .= '<table border="0" cellspacing="0" cellpadding="1" width="100%">
			...
			/*if(!empty($ENROLLMENT_ID_ARR) && count($ENROLLMENT_ID_ARR)>1){
				...
				$txt .= '<table border="0" cellspacing="0" cellpadding="1" width="100%">
							<tr>
								...
								<td width="25%"><b>' . $res_stu->fields['STUDENT_ID'] . '</b></td>
								<td width="25%"></td>
								<td width="25%"></td>
							</tr>';
					while (!$res_type->EOF) {	
						$txt .= '<tr>
								<td width="25%" style="border-top:1px solid #cccccc"><b>Student Status</b></td>
								<td width="25%" style="border-top:1px solid #cccccc"><b>'.$res_type->fields['STUDENT_STATUS'] . '</b></td>
								<td width="25%" style="border-top:1px solid #cccccc"><b>Program</b></td>
								<td width="25%" style="border-top:1px solid #cccccc">'.$res_type->fields['CODE'].'</td>
							</tr>
							<tr>
								<td width="25%"><b>Program Hours</b></td>
								<td width="25%"><b>' . $res_type->fields['HOURS'] . '</b></td>
								<td width="25%"><b>Program Units</b></td>
								<td width="25%"><b>' . $res_type->fields['UNITS'] . '</b></td>
							</tr>
							<tr>
								<td width="25%"><b>First Term</b></td>
								<td width="25%"><b>' . $res_type->fields['TERM_MASTER'] . '</b></td>
								<td width="25%"><b>Grad Date</b></td>
								<td width="25%"><b>' .  $EXPECTED_GRAD_DATE  . '</b></td>
							</tr>
							<tr>
								<td width="25%"><b>Phone</b></td>
								<td width="25%"><b>' .$res_type->fields['CELL_PHONE'] . '</b></td>
								<td width="25%"><b>Date of Birth</b></td>
								<td width="25%"><b>' . $res_stu->fields['DOB'] . '</b></td>
							</tr>';
							$res_type->MoveNext();
						}//while end
				...
				$txt .= '<table border="0" cellspacing="0" cellpadding="3" width="100%">
                                <tr>
                                    ...
                                    <td width="20%"><b>' . $res_stu->fields['STUDENT_ID'] . '</b></td>
									<td width="50%"></td>
                                </tr>
                                <tr>
                                    <td width="30%"><b>Student Status</b></td>
                                    <td width="20%"><b>' . $res_type->fields['STUDENT_STATUS'] . '</b></td>
									<td width="50%"></td>
                                </tr>
                                <tr>
                                    <td width="30%"><b>Program</b></td>
                                    <td width="20%"><b>' . $res_type->fields['CODE'] . '</b></td>
									<td width="50%"></td>
                                </tr>
                                <tr>
                                    <td width="30%"><b>Program Hours</b></td>
                                    <td width="20%"><b>' .$res_type->fields['HOURS']. '</b></td>
									<td width="50%"></td>
                                </tr>
                                <tr>
                                    <td width="30%"><b>Program Units</b></td>
                                    <td width="20%"><b>' . $res_type->fields['UNITS'] . '</b></td>
									<td width="50%"></td>
                                </tr>
                                <tr>
                                    <td width="30%"><b>First Term</b></td>
                                    <td width="20%"><b>' . $res_type->fields['TERM_MASTER'] . '</b></td>
									<td width="50%"></td>
                                </tr>
                                <tr>
                                    <td width="30%"><b>Grad Date</b></td>
                                    <td width="20%"><b>' . $EXPECTED_GRAD_DATE . '</b></td>
									<td width="50%"></td>
                                </tr>
								<tr>
									<td width="30%"><b>Phone</b></td>
									<td width="20%"><b>' .$res_type->fields['CELL_PHONE'] . '</b></td>
									<td width="50%"></td>
								</tr>
								<tr>
									<td width="30%"><b>Date of Birth</b></td>
									<td width="20%"><b>' . $res_stu->fields['DOB'] . '</b></td>
									<td width="50%"></td>
								</tr>
                            </table>';
...
if($_GET['id'] == '') {
	...
	program_grade_book_transcript($_SESSION['PK_STUDENT_MASTER'], 0, $report_name);
} else {
	$report_name = "program_grade_book_transcript";	
