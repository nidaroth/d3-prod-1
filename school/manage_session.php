...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_SESSION WHERE PK_SESSION = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_SESSION_MASTER = 0 ");
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor"><?=SESSION_PAGE_TITLE?> </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="session" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_session"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_SESSION" width="150px" hidden="true" sortable="true" ></th>
													<th field="SESSION" width="780px" align="left" sortable="true" ><?=SESSION?></th>
													<th field="SESSION_ABBREVIATION" width="300px" align="left" sortable="true" ><?=SESSION_ABBREVIATION?></th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='session?id='+selected_row.PK_SESSION;
					}
				}
			});
