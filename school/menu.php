	...
	<nav class="navbar top-navbar navbar-expand-md navbar-dark">
		...
		<div class="navbar-collapse">
			...
			<ul class="navbar-nav my-lg-0">
				...
				<li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle waves-effect waves-dark" href="https://support.diamondsis.com/tickets-view" target="_blank" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-ticket-alt"></i>
						<div class="notify"></div>
					</a>
				</li>
	...
	<div class="scroll-sidebar">
		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
			    ...
			    ");
				if($res_dashboard->fields['CAMPUSIQ_ENABLE'] == 1){ ?>
					<li  ><a class="waves-effect waves-dark" href="campusiq" ><i class="mdi mdi-brightness-7"></i><span class="hide-menu">Campus IQ</span></a></li>
				<?php } ?>
