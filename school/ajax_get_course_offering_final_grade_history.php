...
$res_stu1 = $db->Execute("select S_STUDENT_COURSE_HISTROY.PK_STUDENT_COURSE,S_STUDENT_COURSE_HISTROY.PK_STUDENT_ENROLLMENT,S_STUDENT_MASTER.PK_STUDENT_MASTER,CONCAT(LAST_NAME,', ',FIRST_NAME) AS NAME,FINAL_GRADE,INACTIVE, RETURN_DATE, PK_COURSE_OFFERING_STUDENT_STATUS, MIDPOINT_GRADE, NUMERIC_GRADE, FINAL_GRADE, STUDENT_ID FROM S_STUDENT_MASTER, S_STUDENT_ENROLLMENT, S_STUDENT_COURSE_HISTROY, S_STUDENT_ACADEMICS WHERE S_STUDENT_MASTER.PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND ARCHIVED = 0 AND S_STUDENT_ENROLLMENT.PK_STUDENT_MASTER = S_STUDENT_MASTER.PK_STUDENT_MASTER AND S_STUDENT_MASTER.PK_STUDENT_MASTER = S_STUDENT_ACADEMICS.PK_STUDENT_MASTER AND S_STUDENT_COURSE_HISTROY.PK_STUDENT_ENROLLMENT = S_STUDENT_ENROLLMENT.PK_STUDENT_ENROLLMENT AND PK_COURSE_OFFERING = '$PK_COURSE_OFFERING'  AND S_STUDENT_COURSE_HISTROY.CREATED_ON = '$last_date' ORDER BY CONCAT(LAST_NAME,', ',FIRST_NAME)");
