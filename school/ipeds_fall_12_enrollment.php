	...
	if($_POST['FORMAT'] == 1) {
		...
		$footer = '<table width="100%" >
						<tr>
							...
							<td width="33%" valign="top" style="font-size:10px;" align="center" ><i>COMP20001</i></td>
		...
		if($_POST['REPORT_TYPE'] == 3) {
			...
			$res = $db->Execute("CALL COMP20001(".$_SESSION['PK_ACCOUNT'].", '".$campus_id."', '".$ST."','".$ET."','".$REPORT_TYPE."')");
			while (!$res->EOF) { 
				$txt .= '<tr>
		...
		$res = $db->Execute("CALL COMP20001(".$_SESSION['PK_ACCOUNT'].", '".$campus_id."', '".$ST."','".$ET."','EXCEL')");
		while (!$res->EOF) {
			$line++;
			$index = -1;
                 ...
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">
							<?=MNU_IPEDS_FALL_ENROLLMENT?>  2024-2025 <!-- DIAM-2397 > DIAM-2402 -->
						</h4>
                    </div>
                </div>
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-md-2">
											...
											<? $res_type = $db->Execute("select CAMPUS_CODE,PK_CAMPUS,ACTIVE from S_CAMPUS WHERE  PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' order by ACTIVE DESC, CAMPUS_CODE ASC"); // DIAM-2397 > DIAM-2402
												while (!$res_type->EOF) { 
													 // DIAM-2397 > DIAM-2402
