...
$sort = isset($_POST['sort']) ? strval($_POST['sort']) : 'PK_LOGIN_HISTORY';  
...
$result = array();
$where = " Z_USER.PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND Z_USER.PK_USER = Z_LOGIN_HISTORY.PK_USER ";
