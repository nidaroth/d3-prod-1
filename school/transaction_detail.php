...
if(!empty($_POST)){
	...
	if(isset($_REQUEST['PK_LEDGER_CODE_GROUP'])){
		include_once('transaction_detail_by_code_group.php');
		exit;
	}
	if(isset($_REQUEST['PK_LEDGER_CODE_GROUP'])){
...
<head>
	...
	<title><?=MNU_TRANSACTION_DETAIL?> | <?=$title?></title>
	<style>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row form-group">										
										...
										<div class="col-md-1" >
										<div class="custom-control custom-checkbox mr-sm-12 mt-5">
												<!-- Ticket #974 -->
												<input type="checkbox" class="custom-control-input" id="DISPLAY_SSN" name="DISPLAY_SSN" value="1">
												<label class="custom-control-label" for="DISPLAY_SSN">Display SSN</label>
											</div>
