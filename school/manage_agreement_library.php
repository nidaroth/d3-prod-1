...
if($_GET['act'] == 'del')	{
	//$db->Execute("DELETE FROM S_AGREEMENT_LIBRARY WHERE PK_AGREEMENT_LIBRARY = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' ");
	//$db->Execute("DELETE FROM S_AGREEMENT_LIBRARY_CAMPUS WHERE PK_AGREEMENT_LIBRARY = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' ");
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="agreement_library" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_agreement_library"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_AGREEMENT_LIBRARY" width="150px" hidden="true" sortable="true" ></th>
													<th field="NAME" width="780px" align="left" sortable="true" ><?=NAME?></th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='agreement_library?id='+selected_row.PK_AGREEMENT_LIBRARY;
					}
				}
			});
	...
	function conf_delete(val,id){
		if(val == 1)
			window.location.href = 'manage_agreement_library?act=del&id='+$("#DELETE_ID").val();
		else
