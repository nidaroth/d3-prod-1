...
if(!empty($_POST)){
	/*if($_POST['PK_STUDENT_MASTER'] != '') {
		...
		if($PK_TERM_MASTER == '')
			...
			$q = "&type=3&term=".$PK_TERM_MASTER;
		header("location:course_offering_grade_book_progress_report_pdf?id=".$PK_STUDENT_MASTER."&show=".$_POST['SHOW'].$q);
		exit;
	}*/
	...
	if($_POST['PK_STUDENT_ENROLLMENT'] != '') {
		...
		/* Ticket #1146 */
		header("location:course_offering_grade_book_progress_report_pdf?&id=".$PK_STUDENT_MASTER."&eid=".$PK_STUDENT_ENROLLMENT."&show=".$_POST['SHOW']."&type=1&p=report&exclude_tc=".$_POST['EXCLUDE_TRANSFERS_COURSE']);
		exit;
	}
}
...
<head>
	...
	<title><?=MNU_COURSE_OFFERING_GRADE_BOOK_PROGRESS_REPORT ?> | <?=$title?></title>
	<style>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><?=MNU_COURSE_OFFERING_GRADE_BOOK_PROGRESS_REPORT?></h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                <form class="floating-labels m-t-40" method="post" name="form1" id="form1" >
									<div class="row" style="padding-bottom:10px;" >
										...
										<div class="col-md-2 ">
											<select id="PK_TERM_MASTER" name="PK_TERM_MASTER[]" class="form-control" onchange="search()" >
