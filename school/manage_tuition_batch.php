...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM S_TUITION_BATCH_MASTER WHERE PK_TUITION_BATCH_MASTER = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]'");
	
	 $res_det = $db->Execute("select PK_TUITION_BATCH_DETAIL, PK_STUDENT_FEE_BUDGET, PK_STUDENT_ENROLLMENT, PK_STUDENT_MASTER from S_TUITION_BATCH_DETAIL WHERE PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_TUITION_BATCH_MASTER = '$_GET[id]' ");
	while (!$res_det->EOF) { 
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-6 align-self-center"><!-- DIAM-2158 --> 
                        <h4 class="text-themecolor"><?=TUITION_BATCH_PAGE_TITLE?> </h4>
                    </div>
                    ...
                    <div class="col-md-3 align-self-center text-right"> <!-- DIAM-2158 --> 
                        <div class="d-flex justify-content-end align-items-center">
							<!-- DIAM-2158 --> 
							<a href="tuition_batch_pdf" class="btn btn-info d-none d-lg-block m-l-15"> <?=PDF?></a>
							<a href="tuition_batch_excel" class="btn btn-info d-none d-lg-block m-l-15"><?=EXCEL?></a>
							<!-- DIAM-2158 --> 
                            <a href="tuition_batch" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
				<div class="row pb-4">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_tuition_batch"
										toolbar="#tb" pagination="true" pageSize = 25 autoRowHeight="true" nowrap="false" >
											<thead>
												<tr>
													<th field="PK_TUITION_BATCH_MASTER" width="150px" hidden="true" sortable="true" ></th>
													<th field="BATCH_NO" width="150px" align="left" sortable="true" ><?=BATCH_NO?></th>
													<th field="CAMPUS" width="200px" align="left" sortable="true" ><?=CAMPUS?></th>
													<th field="BATCH_STATUS" width="120px" align="left" sortable="true" ><?=BATCH_STATUS?></th>
													<th field="TRANS_DATE" width="100px" align="left" sortable="true" ><?=BATCH_DATE?></th>
													<th field="POSTED_DATE" width="100px" align="left" sortable="true" ><?=POSTED_DATE?></th>
													<th field="TYPE" width="350px" align="left" sortable="true" ><?=TYPE?></th>
													<th field="TERM_MASTER" width="100px" align="left" sortable="true" ><?=TERM_MASTER?></th>
													<th field="DEBIT" width="130px" align="right" sortable="true" ><?=BATCH_AMOUNT.'<br />('.DEBIT.')'?></th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='tuition_batch?id='+selected_row.PK_TUITION_BATCH_MASTER;
					}
				}
			});
	...
	function conf_delete(val,id){
		if(val == 1)
			window.location.href = 'manage_tuition_batch?act=del&id='+$("#DELETE_ID").val();
		else
