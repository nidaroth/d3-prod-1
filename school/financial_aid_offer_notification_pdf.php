...
class MYPDF extends TCPDF {
    public function Header() {
		...
		$this->SetX(137);
		$this->SetTextColor(000, 000, 000);
		$this->Cell(65, 8, "Offer Letter Notification", 0, false, 'R', 0, '', 0, false, 'M', 'L'); //DIAM-1161
...
$txt = '<table border="0" cellspacing="0" cellpadding="3" width="100%" style="font-size:30px;">
			<tr>
				<td width="50%">
					...
					<br /><br />
					<table border="0" cellspacing="0" cellpadding="3" width="100%" style="font-size:29px;">';
				...
				$txt .= '<tr>
							<td width="100%" style="border-bottom:1px solid #a5a5a5;margin-bottom:10px;font-size:32px;height:25px;"><b>Program Description: ' .  $res_enroll->fields['DESCRIPTION'] . '</b></td>							
						</tr>'; //DIAM-1161 //DIAM-2124
			...
			$ACADEMIC_PERIOD_ARR = array(); // DIAM-1161
			$ACADEMIC_PERIOD_TOTAL_ARR = array(); // DIAM-1161
			...
			$width = 50 / count($ACADEMIC_PERIOD_ARR);
			$txt .= '<tr>
						<td width="35%" style="border-bottom:1px solid #a5a5a5;"><b>Award</b></td>';
					foreach($ACADEMIC_PERIOD_ARR as $ACADEMIC_PERIOD)
						$txt .= '<td width="'.$width.'%" style="text-align:right;border-bottom:1px solid #a5a5a5;" ><b>Academic Period '.$ACADEMIC_PERIOD.'<br><span style="font-size:23px;">'.$ACADEMIC_PERIOD_DATE_ARR[$ACADEMIC_PERIOD].'</span></b></td>';
						
				$txt .= '<td width="15%" style="text-align:right;border-bottom:1px solid #a5a5a5;" ><b>Total</b></td>
					</tr>';
			
			foreach($ACADEMIC_PERIOD_ARR as $ACADEMIC_PERIOD) {
				$ACADEMIC_PERIOD_TOTAL_ARR[$ACADEMIC_PERIOD] = 0;
			}
			//ADDED ENROLL CONDITION HERE AS WELL WAS MISSING PREVIOUSLY
			...
			$LEDGER_CODE_ARR = array(); // DIAM-1161
			$PK_AR_LEDGER_CODE_ARR = array(); // DIAM-1161
		...
		$txt .= '<tr>
					<td width="35%" style="border-top:0.5px solid #000;">Total Awards</td>';
					foreach($ACADEMIC_PERIOD_ARR as $ACADEMIC_PERIOD) {
		...
		$txt .= '<td width="15%" style="border-top:0.5px solid #000;text-align:right;" >$'.number_format_value_checker($grand_right_total,2).'</td>
			</tr>
		</table>
		<br /><br />';
	...
	/*$txt .= '<br /><br /><br /><br />
			<table border="0" cellspacing="0" cellpadding="3" width="100%">
				<tr>
					<td width="15%" >Student signature:</td>
					<td width="50%" style="border-bottom:0.5px solid #000;" ></td>
					<td width="7%" >Date:</td>
					<td width="10%" style="border-bottom:0.5px solid #000;" ></td>
				</tr>
				<tr>
					<td width="100%" ><br /></td>
				</tr>
				<tr>
					<td width="15%" >Parent signature:</td>
					<td width="50%" style="border-bottom:0.5px solid #000;" ></td>
					<td width="7%" >Date:</td>
					<td width="10%" style="border-bottom:0.5px solid #000;" ></td>
				</tr>
