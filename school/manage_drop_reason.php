...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM M_DROP_REASON WHERE PK_DROP_REASON = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_DROP_REASON_MASTER = 0");
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor"><?=DROP_REASON_PAGE_TITLE?> </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="drop_reason" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_drop_reason"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_DROP_REASON" width="150px" hidden="true" sortable="true" ></th>
													<th field="DROP_REASON" width="380px" align="left" sortable="true" ><?=DROP_REASON?></th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='drop_reason?id='+selected_row.PK_DROP_REASON;
					}
				}
			});
