...
while($row = mysql_fetch_array($rs)){
	...
	$CAMPUS = "";
	$res_campus = $db->Execute("SELECT CAMPUS_CODE FROM S_CAMPUS, S_STUDENT_CAMPUS WHERE S_CAMPUS.PK_CAMPUS = S_STUDENT_CAMPUS.PK_CAMPUS  AND PK_STUDENT_ENROLLMENT = '$PK_STUDENT_ENROLLMENT' ");
	...
	$res1 = $db->Execute("SELECT S_STUDENT_COURSE_CANVAS.CREATED_ON, CONCAT(LAST_NAME,', ',FIRST_NAME) as NAME, MESSAGE FROM S_STUDENT_COURSE_CANVAS LEFT JOIN Z_USER ON Z_USER.PK_USER = S_STUDENT_COURSE_CANVAS.CREATED_BY AND PK_USER_TYPE IN (1,2) LEFT JOIN S_EMPLOYEE_MASTER ON S_EMPLOYEE_MASTER.PK_EMPLOYEE_MASTER = Z_USER.ID WHERE PK_STUDENT_COURSE = '$PK_STUDENT_COURSE' ORDER BY PK_STUDENT_COURSE_CANVAS DESC ");	
