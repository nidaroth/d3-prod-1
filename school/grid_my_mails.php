...
$query = "SELECT * FROM (SELECT Z_INTERNAL_EMAIL.PK_INTERNAL_EMAIL, Z_INTERNAL_EMAIL.INTERNAL_ID, SUBJECT, Z_INTERNAL_EMAIL.CREATED_ON FROM Z_INTERNAL_EMAIL,Z_USER WHERE " . $where ." ORDER BY Z_INTERNAL_EMAIL.INTERNAL_ID DESC) AS TEMP GROUP BY INTERNAL_ID order by $sort $order " ;
//echo $query;exit;	
