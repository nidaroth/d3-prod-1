...
if(!empty($_POST)){
	if($_POST['PK_STUDENT_MASTER'] != '') {
		...
		header("location:grade_book_report_card_pdf?id=".$PK_STUDENT_MASTER."&dt=".$_POST['START_DATE'].'&report_type='.$_POST['GRADE_BOOK_REPORT_TYPE']);
		exit;
	}
}
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><?=MNU_PROGRAM_GRADE_BOOK_REPORT_CARD?></h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
