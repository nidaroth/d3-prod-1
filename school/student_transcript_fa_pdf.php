...
class MYPDF extends TCPDF {
    ...
    public function Header() {
		...
		if($_SESSION['temp_id'] == $this->PK_STUDENT_MASTER){
			...
			if($_GET['uno'] == 1)
				$uno = 'Unofficial ';
			$this->Cell(55, 8, $uno." Student Transcript", 0, false, 'L', 0, '', 0, false, 'M', 'L');
		} else {
    ...
    public function Footer() {
		...
		$res_type = $db->Execute("SELECT FOOTER_LOC, CONTENT FROM S_PDF_FOOTER,S_PDF_FOOTER_CAMPUS WHERE S_PDF_FOOTER.ACTIVE = 1 AND S_PDF_FOOTER.PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PDF_FOR = 11 AND S_PDF_FOOTER.PK_PDF_FOOTER = S_PDF_FOOTER_CAMPUS.PK_PDF_FOOTER AND PK_CAMPUS = '$PK_CAMPUS'  ");
...
function student_transcript_pdf($PK_STUDENT_MASTERS, $one_stud_per_pdf, $report_name){
	...
	foreach($PK_STUDENT_MASTER_ARR as $PK_STUDENT_MASTER) {
	 ...
	 if($res_term->RecordCount() > 0) // DIAM-2239
	 {
		...
		/* if($uno != '' && $_GET['id'] != '') {
			...
			$myPageHeight = $pdf->getPageHeight() - ($FOOTER_LOC + 10);
			$myX = ( $myPageWidth / 2 ) - 90;  //WaterMark Positioning
			$myY = ( $myPageHeight / 2 ) - 80;
		...
		$txt .= '<div style="border-top: 2px #c0c0c0 solid" ></div>
				<table border="0" cellspacing="0" cellpadding="3" width="100%" >
					...
					<tr>
						<td width="18%" ><br /><br /><u><b>Course</b></u></td>
						<td width="26%" ><br /><br /><u><b>Course Description</b></u></td>';
				...
				$txt .= '<td width="9%" align="right" ><b>Units</b><br /><u><b>Attempted</b></u></td>
						<td width="9%" align="right" ><b>Units</b><br /><u><b>Completed</b></u></td>
						<td width="9%" align="right" ><b>FA Units</b><br /><u><b>Attempted</b></u></td>
						<td width="9%" align="right" ><b>FA Units</b><br /><u><b>Completed</b></u></td>
						<td width="6%" align="right" ><br /><br /><u><b>GPA</b></u></td>
					</tr>';
					...
					if($_GET['exclude_tc'] != 1) {
						...
						while (!$res_tc->EOF) {
							...
							$Numerator1	 += $res_tc->fields['UNITS'] * $res_grade_top->fields['NUMBER_GRADE']; //diam-726
							
							$Sub_Denominator += $res_tc->fields['UNITS'];
							$Sub_Numerator1	 += $res_tc->fields['UNITS'] * $res_grade_top->fields['NUMBER_GRADE']; //diam-726
						
							$res_tc->MoveNext();
						}
						//DIAM-781
						$sSQL = "SELECT S_COURSE.TRANSCRIPT_CODE, 
						...
						while (!$res_tc->EOF) {
							...
							$txt .= '<tr>
										<td width="18%" >'.$res_tc->fields['TRANSCRIPT_CODE'].'</td>
										<td width="26%" ></td>';
								...
								$txt .= '<td width="9%" align="right" >'.number_format_value_checker($ATTEMPTED_UNITS,2).'</td>
										<td width="9%" align="right" >'.number_format_value_checker($COMPLETED_UNITS,2).'</td>
										<td width="9%" align="right" >'.number_format_value_checker($FA_ATTEMPTED_UNITS,2).'</td>
										<td width="9%" align="right" >'.number_format_value_checker($FA_COMPLETED_UNITS,2).'</td>
						...
						$width_1 = 54;
						if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 1 || $res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 2)
							$width_1 -= 6;
						else if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3)
							$width_1 -= 10;

						if($res_tc->RecordCount() > 0) {
							$txt .= '<tr>
								<td width="'.$width_1.'%" style="border-top:1px solid #c0c0c0" align="right" ><i>Term Transfer Total: </i></td>';
								
								if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 1 || $res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3)
									$txt .= '<td width="6%" style="border-top:1px solid #c0c0c0" align="right" ></td>';
								...
								$txt .= '<td width="9%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($c_in_att_sub_tot,2).'</b></i></td>
								<td width="9%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($c_in_comp_sub_tot,2).'</b></i></td>
								<td width="9%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($c_fa_in_att_sub_tot,2).'</b></i></td>
								<td width="9%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($c_fa_in_comp_sub_tot,2).'</b></i></td>
								<td width="6%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($tc_gpa_weighted,2).'</b></i></td>
							</tr>
							<tr>
								<td width="'.$width_1.'%" align="right" ><i>Cumulative Total: </i></td>';
								
								if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 1 || $res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3)
									$txt .= '<td width="6%"  align="right" ></td>';
							...
							$txt .= '<td width="9%" align="right" ><i><b style="font-size:35px">'.number_format_value_checker($c_in_att_tot,2).'</b></i></td>
								<td width="9%" align="right" ><i><b style="font-size:35px">'.number_format_value_checker($c_in_comp_tot,2).'</b></i></td>
								<td width="9%" align="right" ><i><b style="font-size:35px">'.number_format_value_checker($c_fa_in_att_tot,2).'</b></i></td>
								<td width="9%" align="right" ><i><b style="font-size:35px">'.number_format_value_checker($c_fa_in_comp_tot,2).'</b></i></td>
								<td width="6%" align="right" ><i><b style="font-size:35px">'.number_format_value_checker(($summation_of_gpa/$summation_of_weight),2).'</b></i></td>
							</tr>';
						}
						$txt .= '</table>';
					}
					...
					while (!$res_term->EOF) {
						...
						if(has_wvjc_access_transcript_desc($_SESSION['PK_ACCOUNT'],1)){
							if(has_wvjc_access_show_only_term_desc($_SESSION['PK_ACCOUNT'],1)){ 
								$BEGIN_DATE 	= ($res_term->fields['TERM_DESCRIPTION'] != '') ? $res_term->fields['TERM_DESCRIPTION'] : $res_term->fields['BEGIN_DATE'];
							}else{
								if(!empty($res_term->fields['TERM_DESCRIPTION'])){
									$dash_desc = ' - '.$res_term->fields['TERM_DESCRIPTION'];
								}	
								$BEGIN_DATE 	= $res_term->fields['BEGIN_DATE'].$dash_desc;
							}
						}else{
							$BEGIN_DATE 	= $res_term->fields['BEGIN_DATE'];
						}
						...
						$txt .= '<table border="0" cellspacing="0" cellpadding="0" width="100%" >
									<tr nobr="true">
										<td width="100%" >
											<table border="0" cellspacing="0" cellpadding="3" width="100%" >
												<tr>
													<td width="100%" ><i style="font-size:45px">Term: '.$BEGIN_DATE.'</i></td>
												</tr>';
						...
						//DIAM-781
						$res_course = $db->Execute("SELECT TRANSCRIPT_CODE, 
														COURSE_DESCRIPTION, 
														FA_UNITS, 
						...
						while (!$res_course->EOF) { 
							...
							if($res_course->fields['UNITS_COMPLETED'] == 1) {
								...
								$c_fa_in_comp_sub_tot   += $FA_COMPLETED_UNITS;
								$c_fa_comp_tot  		+= $FA_COMPLETED_UNITS;
								$c_fa_in_comp_tot  		+= $FA_COMPLETED_UNITS;
							...
							$txt .= '<tr>
										<td width="18%" >'.$res_course->fields['TRANSCRIPT_CODE'].'</td>
										<td width="26%" >'.$res_course->fields['COURSE_DESCRIPTION'].'</td>';
										
										if($res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 1 || $res_sp_set->fields['GRADE_DISPLAY_TYPE'] == 3)
											$txt .= '<td width="6%" >'.$res_course->fields['GRADE'].'</td>';
						...
						// $gpa11 = 0;
						// if($c_in_comp_tot > 0)
						// 	$gpa11 = $c_in_cu_gnu / $c_in_comp_tot;
						...
						$txt .= '<tr>
								<td width="44%" style="border-top:1px solid #c0c0c0" align="right" ><i>Term '.$BEGIN_DATE.' Total: </i></td>';
						...
						$txt .= '<td width="9%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($c_in_att_sub_tot,2).'</b></i></td>
							...
							<td width="9%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($c_fa_in_att_sub_tot,2).'</b></i></td>
							<td width="9%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($c_fa_in_comp_sub_tot,2).'</b></i></td>
							<td width="6%" style="border-top:1px solid #c0c0c0" align="right" ><i><b style="font-size:30px">'.number_format_value_checker($gpa_weighted,2).'</b></i></td>
						</tr>
						<tr>
							<td width="44%" colspan="2" align="right" ><i><b style="font-size:35px">Cumulative Total: </b></i></td>';
...
if($_GET['id'] == '') {
	...
	if($_GET['zip'] == 1) {
		...
		// $folder = '../backend_assets/school/school_'.$_SESSION['PK_ACCOUNT'].'/other/student_transcripts_fa_units';
		$folder = '../backend_assets/tmp_upload/student_transcripts_fa_units';
