...
if($_GET['act'] == 'del')	{
	...
	$res = $db->Execute("DELETE FROM S_AWARD_LETTER WHERE PK_AWARD_LETTER = '$_GET[id]' $cond ");
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor"><?=AWARD_LETTER_PAGE_TITLE?> </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="award_letter_text" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_award_letter_text"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_AWARD_LETTER" width="150px" hidden="true" sortable="true" ></th>
													<? if($_SESSION['PK_ROLES'] == 2) { ?>
														<th field="OFFICIAL_CAMPUS_NAME" width="300px" align="left" sortable="true" ><?=CAMPUS?></th>
														<th field="NAME" width="400px" align="left" sortable="true" ><?=NAME?></th>
													<? } else if($_SESSION['PK_ROLES'] == 3) { ?>
														<th field="NAME" width="7000px" align="left" sortable="true" ><?=NAME?></th>
													<? } ?>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='award_letter_text?id='+selected_row.PK_AWARD_LETTER;
					}
				}
			});
	...
	function conf_delete(val,id){
		if(val == 1)
			window.location.href = 'manage_award_letter_text?act=del&id='+$("#DELETE_ID").val();
		else
