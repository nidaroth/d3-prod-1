...
if(!empty($_POST)){
		...
		include_once("custom_program_grade_book_report_card_pdf.php");
		exit;
}	
?>
<!DOCTYPE html>
...
<head>
	...
	<title><?=MNU_PROGRAM_GRADE_BOOK_REPORT_CARD?> | <?=$title?></title>
                 ...
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">
							<?=MNU_PROGRAM_GRADE_BOOK_REPORT_CARD?>
						</h4>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <form class="floating-labels" method="post" name="form1" id="form1" >
									...
									<div class="row">
										...
										<div class="col-md-2 align-self-center" style="max-width: 20%;flex: 0 0 20%;" id="GRADE_BOOK_REPORT_TYPE_div" >
									...
									<div id="student_div" >
											...
											<div class="col-md-12">
												<? if($_SESSION['SORT_FIELD'] != '')
													...
													$sort = '' ?>
												<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" nowrap="false" autoRowHeight="true" url="grid_search_student_for_report"
