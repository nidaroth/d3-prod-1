								...
								<div class="card-body">
									...
									<div class="panel">
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 84;
												$db_res = check_field($db,"S_STUDENT_MASTER.PATERNAL_LAST_NAME AS PATERNAL_LAST_NAME","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="S_STUDENT_MASTER.PATERNAL_LAST_NAME AS PATERNAL_LAST_NAME" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 85;
												$db_res = check_field($db,"S_STUDENT_MASTER.MATERNAL_LAST_NAME AS MATERNAL_LAST_NAME","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="S_STUDENT_MASTER.MATERNAL_LAST_NAME AS MATERNAL_LAST_NAME" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 8;
												$db_res = check_field($db,"IF(S_STUDENT_MASTER.DATE_OF_BIRTH != '0000-00-00',DATE_FORMAT(S_STUDENT_MASTER.DATE_OF_BIRTH,'%Y-%m-%d'),'') AS DATE_OF_BIRTH","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_MASTER.DATE_OF_BIRTH != '0000-00-00',DATE_FORMAT(S_STUDENT_MASTER.DATE_OF_BIRTH,'%Y-%m-%d'),'') AS DATE_OF_BIRTH" onclick="enable_size('INFO','<?=$index?>')" />
                                        ...
                                        <div class="row" style="margin-bottom:5px" >
                                            <div class="col-md-2">
                                                <? $index = 88;
                                                $db_res = check_field($db,"S_STUDENT_MASTER.LSQ_ID AS LSQ_ID","INFO"); ?>
                                                <input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="S_STUDENT_MASTER.LSQ_ID AS LSQ_ID" onclick="enable_size('INFO','<?=$index?>')" />
                                        ...
                                        <div class="row" style="margin-bottom:5px" >
                                            <div class="col-md-2">
                                                <? $index = 89;
                                                $db_res = check_field($db,"(SELECT JSON_UNQUOTE(JSON_EXTRACT(LSQ_DATA, '$.ProspectAutoId')) FROM S_STUDENT_LSQ WHERE S_STUDENT_LSQ.PK_STUDENT_MASTER = S_STUDENT_MASTER.PK_STUDENT_MASTER LIMIT 1) AS PROSPECT_AUTO_ID","INFO"); ?>
                                                <input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="(SELECT JSON_UNQUOTE(JSON_EXTRACT(LSQ_DATA, '$.ProspectAutoId')) FROM S_STUDENT_LSQ WHERE S_STUDENT_LSQ.PK_STUDENT_MASTER = S_STUDENT_MASTER.PK_STUDENT_MASTER LIMIT 1) AS PROSPECT_AUTO_ID" onclick="enable_size('INFO','<?=$index?>')" />
									...
									<div class="panel">
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 28;
												$db_res = check_field($db,"IF(S_TERM_MASTER.BEGIN_DATE = '0000-00-00','',DATE_FORMAT(S_TERM_MASTER.BEGIN_DATE,'%Y-%m-%d' )) AS BEGIN_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_TERM_MASTER.BEGIN_DATE = '0000-00-00','',DATE_FORMAT(S_TERM_MASTER.BEGIN_DATE,'%Y-%m-%d' )) AS BEGIN_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 32;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.MIDPOINT_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.MIDPOINT_DATE,'%Y-%m-%d' )) AS MIDPOINT_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.MIDPOINT_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.MIDPOINT_DATE,'%Y-%m-%d' )) AS MIDPOINT_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 33;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.EXTERN_START_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.EXTERN_START_DATE,'%Y-%m-%d' )) AS EXTERN_START_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.EXTERN_START_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.EXTERN_START_DATE,'%Y-%m-%d' )) AS EXTERN_START_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 34;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.EXPECTED_GRAD_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.EXPECTED_GRAD_DATE,'%Y-%m-%d' )) AS EXPECTED_GRAD_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.EXPECTED_GRAD_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.EXPECTED_GRAD_DATE,'%Y-%m-%d' )) AS EXPECTED_GRAD_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 86;
												$db_res = check_field($db,"MES.CODE AS ORIGINAL_ENROLLMENT_STATUS","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="MES.CODE AS ORIGINAL_ENROLLMENT_STATUS" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 35;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.GRADE_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.GRADE_DATE,'%Y-%m-%d' )) AS GRADE_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.GRADE_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.GRADE_DATE,'%Y-%m-%d' )) AS GRADE_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 36;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.LDA = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.LDA,'%Y-%m-%d' )) AS LDA","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.LDA = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.LDA,'%Y-%m-%d' )) AS LDA" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 37;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.DETERMINATION_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.DETERMINATION_DATE,'%Y-%m-%d' )) AS DETERMINATION_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.DETERMINATION_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.DETERMINATION_DATE,'%Y-%m-%d' )) AS DETERMINATION_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 38;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.DROP_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.DROP_DATE,'%Y-%m-%d' )) AS DROP_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.DROP_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.DROP_DATE,'%Y-%m-%d' )) AS DROP_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 42;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.CONTRACT_SIGNED_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.CONTRACT_SIGNED_DATE,'%Y-%m-%d' )) AS CONTRACT_SIGNED_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.CONTRACT_SIGNED_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.CONTRACT_SIGNED_DATE,'%Y-%m-%d' )) AS CONTRACT_SIGNED_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 43;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.CONTRACT_END_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.CONTRACT_END_DATE,'%Y-%m-%d' )) AS CONTRACT_END_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.CONTRACT_END_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.CONTRACT_END_DATE,'%Y-%m-%d' )) AS CONTRACT_END_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 44;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.ENTRY_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.ENTRY_DATE,'%Y-%m-%d' )) AS ENTRY_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.ENTRY_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.ENTRY_DATE,'%Y-%m-%d' )) AS ENTRY_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 46;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.ORIGINAL_EXPECTED_GRAD_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.ORIGINAL_EXPECTED_GRAD_DATE,'%Y-%m-%d' )) AS ORIGINAL_EXPECTED_GRAD_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.ORIGINAL_EXPECTED_GRAD_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.ORIGINAL_EXPECTED_GRAD_DATE,'%Y-%m-%d' )) AS ORIGINAL_EXPECTED_GRAD_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 48;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.FT_PT_EFFECTIVE_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.FT_PT_EFFECTIVE_DATE,'%Y-%m-%d' )) AS FT_PT_EFFECTIVE_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.FT_PT_EFFECTIVE_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.FT_PT_EFFECTIVE_DATE,'%Y-%m-%d' )) AS FT_PT_EFFECTIVE_DATE" onclick="enable_size('INFO','<?=$index?>')" />
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 87;
												$db_res = check_field($db,"M_RESIDENCY_TUITION_STATUS.DESCRIPTION_CODE AS RESIDENCY_TUITION_STATUS","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="M_RESIDENCY_TUITION_STATUS.DESCRIPTION_CODE AS RESIDENCY_TUITION_STATUS" onclick="enable_size('INFO','<?=$index?>')" />
												
												<input type="hidden" name="INFO_HID[]" value="<?=$index?>" >
												<input type="hidden" name="INFO_PK_CUSTOM_REPORT_DETAIL_<?=$index?>" value="<?=$db_res[2]?>" />
											</div>
											<div class="col-md-6">
												<?=RESIDENCY_TUITION_STATUS?>
											</div>
											<div class="col-md-2">
												<input type="number" min="0" oninput="validity.valid||(value='');" name="INFO_SORT_ORDER_<?=$index?>" id="INFO_SORT_ORDER_<?=$index?>"  class="form-control sort_cls" value="<?=$db_res[3]?>" <? if($db_res[0] == 0 ) echo "disabled"; ?> onchange="calc_disp()" />
											</div>
										...
										<div class="row" style="margin-bottom:5px" >
											<div class="col-md-2">
												<? $index = 57;
												$db_res = check_field($db,"IF(S_STUDENT_ENROLLMENT.STRF_PAID_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.STRF_PAID_DATE,'%Y-%m-%d' )) AS STRF_PAID_DATE","INFO"); ?>
												<input type="checkbox" <? if($db_res[0] > 0 ) echo "checked='checked'"; ?> name="INFO_<?=$index?>" id="INFO_<?=$index?>" value="IF(S_STUDENT_ENROLLMENT.STRF_PAID_DATE = '0000-00-00','',DATE_FORMAT(S_STUDENT_ENROLLMENT.STRF_PAID_DATE,'%Y-%m-%d' )) AS STRF_PAID_DATE" onclick="enable_size('INFO','<?=$index?>')" />
