...
if(!empty($_POST)){
	//Ticket # 1187
	header("location:student_transcript_list_pdf?id=".implode(",",$_POST['PK_STUDENT_MASTER']).'&exclude_tc='.$_POST['EXCLUDE_TRANSFERS_COURSE'].'&inc_att='.$_POST['DISPLAY_ATTENDNACE']);	
	exit;
}
...
<head>
	...
	<title><?=STUDENT_TRANSCRIPT_LIST?> | <?=$title?></title>
	<style>
