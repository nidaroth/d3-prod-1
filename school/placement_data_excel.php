...
include '../global/excel/Classes/PHPExcel/IOFactory.php';
        ...
        $file_name 		= 'ACCET_Placement Data.xlsx';
        ...
        $line 	= 1;	
        $index 	= -1;
        //echo "CALL ACCET10002(".$_SESSION['PK_ACCOUNT'].", '".$PK_CAMPUS."','".$ST."','".$ET."', 'Placement Data')";
        //exit;
        $res = $db->Execute("CALL ACCET10002(".$_SESSION['PK_ACCOUNT'].", '".$PK_CAMPUS."','".$ST."','".$ET."', 'Placement Data')");	
