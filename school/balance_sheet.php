...
if(!empty($_POST)){
	...
	header("location:balance_sheet_pdf?id=".$stud_id."&cur_en=".$cur_en);
	exit;
}
...
<head>
	...
	<title><?=MNU_BALANCE_SHEET ?> | <?=$title?></title>
	<style>
	...
	<script type="text/javascript">
		...
		function search(){
			jQuery(document).ready(function($) {
				var data  = 'PK_STUDENT_GROUP='+$('#PK_STUDENT_GROUP').val()+'&PK_TERM_MASTER='+$('#PK_TERM_MASTER').val()+'&PK_CAMPUS_PROGRAM='+$('#PK_CAMPUS_PROGRAM').val()+'&PK_STUDENT_STATUS='+$('#PK_STUDENT_STATUS').val()+'&PK_CAMPUS='+$('#PK_CAMPUS').val()+'&show_check=1&show_count=1&ENROLLMENT=2';
				var value = $.ajax({
