...
if(!empty($_POST)){
	...
	if($_GET['id'] == ''){
		...
		$QUESTIONNAIRE['EDITED_BY'] = $_SESSION['PK_USER'];
		$QUESTIONNAIRE['EDITED_ON'] = date("Y-m-d H:i");
		db_perform('M_QUESTIONNAIRE', $QUESTIONNAIRE, 'update'," PK_QUESTIONNAIRE = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' ");
	}
...
if($_GET['id'] == ''){
	...
	/*$res = $db->Execute("SELECT MAX(DISPLAY_ORDER) as DISPLAY_ORDER FROM M_QUESTIONNAIRE WHERE PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' "); 
	$DISPLAY_ORDER	= $res->fields['DISPLAY_ORDER'] + 1;*/
	$DISPLAY_ORDER	= '';
	
} else {
	$res = $db->Execute("SELECT * FROM M_QUESTIONNAIRE WHERE PK_QUESTIONNAIRE = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' "); 
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-12 align-self-center">
                        <h4 class="text-themecolor"><? if($_GET['id'] == '') echo ADD; else EDIT; ?> <?=QUESTIONNAIRE_PAGE_TITLE?></h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                <form class="floating-labels m-t-40" method="post" name="form1" id="form1" >
									...
									<div class="row">
                                        <div class="col-md-6">
											<div class="form-group m-b-40">
												<input type="text" class="form-control required-entry" id="QUESTION" name="QUESTION" value="<?=$QUESTION?>" >
												<span class="bar"></span>
