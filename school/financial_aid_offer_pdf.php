	...
	public function Header()
	{
		...
		if ($_GET['id'] != '') {
			...
			if ($this->PageNo() > 0 ) {
				...
				$CONTENT = '<b>'.str_replace("<br /><br />", "<br />", $CONTENT).'</b>'; //DAIM-1160 
...
$txt .= '<tr>
				<td width="55%" style="border-top:0.5px solid #000;">Total Awards</td>
				<td width="45%" style="border-top:0.5px solid #000;text-align:right;" >$' . number_format_value_checker($total, 2) . '</td>
			</tr>
		</table>
		<br /><br />';
