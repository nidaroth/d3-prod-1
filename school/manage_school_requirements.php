...
if($_GET['act'] == 'del')	{
	$db->Execute("DELETE FROM S_SCHOOL_REQUIREMENT WHERE PK_SCHOOL_REQUIREMENT = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]'");
	header("location:manage_school_requirements");
} ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
                 ...
                 <div class="row page-titles">
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="school_requirements" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_school_requirements"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_SCHOOL_REQUIREMENT" width="150px" hidden="true" sortable="true" ></th>
													<th field="REQUIREMENT" width="780px" align="left" sortable="true" ><?=REQUIREMENT?></th>
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='school_requirements?id='+selected_row.PK_SCHOOL_REQUIREMENT;
					}
				}
			});
	...
	function conf_delete(val,id){
		if(val == 1)
			window.location.href = 'manage_school_requirements?act=del&id='+$("#DELETE_ID").val();
		else
