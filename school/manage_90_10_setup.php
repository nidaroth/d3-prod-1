            ...
            <div class="container-fluid">
                 <div class="row page-titles">
					...
					<div class="col-md-1 align-self-center text-right" style="flex: 0 0 14.33333%;max-width: 14.33333%;" >
                        <select id="LEDGER_CODE_SATATUS" name="LEDGER_CODE_SATATUS" class="form-control" onchange="doSearch()">
							<option value="2">Ledger Code</option>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_90_10_setup"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_AR_LEDGER_CODE" width="150px" hidden="true" sortable="true" ></th>
													<th field="CODE" width="400px" align="left" sortable="true" ><?=LEDGER_CODE?></th>
													<th field="CATEGORY_NAME" width="500px" align="left" sortable="true" ><?=_90_10_GROUP?></th>
													<th field="ACTIVE_1" width="80px" align="left" sortable="false" ><?=ACTIVE?></th><!--//DIAM-1680 -->
	...
	function doSearch(){
		jQuery(document).ready(function($) {
			$('#tt').datagrid('load',{
				SEARCH  : $('#SEARCH').val(),
				TYPE    : $('#TYPE').val(),
				LEDGER_CODE_SATATUS : $('#LEDGER_CODE_SATATUS').val(), //DIAM-1680
			});
		});	
	}
	function search(e){
			...
			$('#tt').datagrid({
				onClickCell: function(rowIndex, field, value){
					...
					if(field != 'ACTION' ){
						...
						window.location.href='90_10_setup?id='+selected_row.PK_AR_LEDGER_CODE;
					}
				}
			});
