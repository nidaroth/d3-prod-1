...
if($_GET['act'] == 'del')	{
	$res_check1 = $db->Execute("select PK_ENROLL_MANDATE_FIELDS from S_ENROLL_MANDATE_FIELDS WHERE PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_FUNDING = '$_GET[id]' ");
	$res_check2 = $db->Execute("select PK_STUDENT_ENROLLMENT from S_STUDENT_ENROLLMENT WHERE PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_FUNDING = '$_GET[id]' ");
	if($res_check1->RecordCount() == 0 && $res_check2->RecordCount() == 0 )
		$db->Execute("DELETE FROM M_FUNDING WHERE PK_FUNDING = '$_GET[id]' AND PK_ACCOUNT = '$_SESSION[PK_ACCOUNT]' AND PK_FUNDING_MASTER = 0");;
...
<body class="horizontal-nav boxed skin-megna fixed-layout">
   <? require_once("pre_load.php"); ?>
            ...
            <div class="container-fluid">
                 <div class="row page-titles">
                    <div class="col-md-7 align-self-center">
                        <h4 class="text-themecolor"><?=FUNDING_PAGE_TITLE?> </h4>
                    </div>
                    ...
                    <div class="col-md-2 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <a href="funding" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> <?=CREATE_NEW?></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<table id="tt" striped = "true" class="easyui-datagrid table table-bordered table-striped" url="grid_funding"
										toolbar="#tb" pagination="true" pageSize = 25 >
											<thead>
												<tr>
													<th field="PK_FUNDING" width="150px" hidden="true" sortable="true" ></th>
													<th field="FUNDING" width="380px" align="left" sortable="true" ><?=FUNDING?></th>
	...
	function conf_delete(val,id){
		if(val == 1)
			window.location.href = 'manage_funding?act=del&id='+$("#DELETE_ID").val();
		else
