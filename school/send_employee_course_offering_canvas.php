...
if(!empty($_POST)){
	...
	foreach($_POST['PK_COURSE_OFFERING'] as $PK_COURSE_OFFERING_TEMP){
		...
		assign_instructor_to_course_offering($PK_COURSE_OFFERING,$PK_EMPLOYEE_MASTER,$_SESSION['PK_ACCOUNT'],$BATCH_ID);
		
	}
	header("location:send_employee_course_offering_canvas_result?id=".$BATCH_ID);
}
...
<head>
	...
	<title>
		<?=MNU_SEND_COURSE_OFFERING_INSTRUCTOR ?> | <?=$title?>
	</title>
				...
				<div class="row page-titles" style="padding-bottom: 10px;" >
                    <div class="col-md-2 align-self-center">
                        <h4 class="text-themecolor">
							<?=MNU_SEND_COURSE_OFFERING_INSTRUCTOR ?>
						</h4>
                    </div>
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-12">
											...
											url="grid_send_employee_course_offering_canvas" toolbar="#tb" pagination="true" pageSize = 25 >
												<thead>
													<tr>
