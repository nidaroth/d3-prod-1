...
if(!empty($_POST)){
	//Ticket # 1187
	header("location:student_transcript_list_numeric_grade_pdf?id=".implode(",",$_POST['PK_STUDENT_MASTER']).'&exclude_tc='.$_POST['EXCLUDE_TRANSFERS_COURSE'].'&inc_att='.$_POST['DISPLAY_ATTENDNACE']);	
	exit;
}
...
<head>
	...
	<title><?=STUDENT_TRANSCRIPT_LIST_NUMBER_GRADE?> | <?=$title?></title>
	<style>
                 ...
                 <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">
							<?=STUDENT_TRANSCRIPT_LIST_NUMBER_GRADE ?>
						</h4>
                    </div>
                </div>
